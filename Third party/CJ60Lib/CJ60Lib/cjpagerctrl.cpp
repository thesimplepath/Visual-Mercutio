...
BEGIN_MESSAGE_MAP(CCJPagerCtrl, CWnd)
	...
	ON_NOTIFY_REFLECT_EX(PGN_SCROLL, (BOOL(CCmdTarget::*)(NMHDR *, LRESULT *))OnPagerScroll)
	ON_NOTIFY_REFLECT_EX(PGN_CALCSIZE, (BOOL(CCmdTarget::*)(NMHDR *, LRESULT *))OnPagerCalcSize)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
