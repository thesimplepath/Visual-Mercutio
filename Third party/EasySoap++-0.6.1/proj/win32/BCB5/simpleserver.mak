...
VERSION = BCB.05.03
# ---------------------------------------------------------------------------
PROJECT = ..\..\..\win32\Release\simpleserver.exe
OBJFILES = ..\..\..\win32\Release\obj\simpleserver.obj
RESFILES = 
MAINSOURCE = simpleserver.bpf
RESDEPEN = $(RESFILES)
...
DEFFILE = 
# ---------------------------------------------------------------------------
PATHCPP = .;..\..\..\simpleserver
PATHASM = .;
PATHPAS = .;
PATHRC = .;
DEBUGLIBPATH = $(BCB)\lib\debug
RELEASELIBPATH = $(BCB)\lib\release
USERDEFINES = WIN32;NDEBUG;_CONSOLE;_MBCS;_WINDOWS;_USRDLL;_DEBUG
SYSDEFINES = _NO_VCL;_ASSERTE;NO_STRICT;_RTLDLL
INCLUDEPATH = ..\..\..\include;..\..\..\simpleserver;$(BCB)\include
LIBPATH = ..\..\..\simpleserver;$(BCB)\lib;..\..\..\simpleserver\$(RELEASELIBPATH)
