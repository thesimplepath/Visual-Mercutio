...
VERSION = BCB.05.03
# ---------------------------------------------------------------------------
PROJECT = ..\..\..\win32\Release\simpleisapi.dll
OBJFILES = ..\..\..\win32\Release\obj\isapi.obj \
    ..\..\..\win32\Release\obj\simpleisapi.obj
RESFILES = 
MAINSOURCE = simpleisapi.bpf
RESDEPEN = $(RESFILES)
...
SPARELIBS = 
DEFFILE = ..\..\..\src\isapi.def
# ---------------------------------------------------------------------------
PATHCPP = .;..\..\..\src;..\..\..\simpleserver
PATHASM = .;
PATHPAS = .;
PATHRC = .;
...
INCLUDEPATH = ..\..\..\include;..\..\..\simpleserver;..\..\..\src;$(BCB)\include
LIBPATH = ..\..\..\simpleserver;..\..\..\src;$(BCB)\lib;..\..\..\simpleserver\$(RELEASELIBPATH)
WARNINGS= -w-8026 -w-8027 -w-par
# ---------------------------------------------------------------------------
CFLAG1 = -WD -Od -w -X- -r- -a8 -5 -b -k -y -v -vi- -q -tWR -tWM -I../include -c -tWD
