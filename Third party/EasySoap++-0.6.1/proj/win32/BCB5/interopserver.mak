...
VERSION = BCB.05.03
# ---------------------------------------------------------------------------
PROJECT = ..\..\..\win32\Release\interopserver.exe
OBJFILES = ..\..\..\win32\Release\obj\interopserver.obj \
    ..\..\..\win32\Release\obj\SOAPBuildersHeaderHandler.obj \
    ..\..\..\win32\Release\obj\SOAPBuildersInteropHandler.obj \
    ..\..\..\win32\Release\obj\SOAPBuildersInteropHandlerA.obj \
    ..\..\..\win32\Release\obj\SOAPBuildersInteropHandlerB.obj
RESFILES = 
MAINSOURCE = interopserver.bpf
RESDEPEN = $(RESFILES)
LIBFILES = ..\..\..\win32\release\easysoap.lib
IDLFILES = 
IDLGENFILES = 
LIBRARIES = 
...
LIBPATH = ..\..\..\tests;$(BCB)\lib;..\..\..\tests\$(RELEASELIBPATH)
WARNINGS= -w-8026 -w-8027 -w-par
# ---------------------------------------------------------------------------
CFLAG1 = -Od -w -X- -r- -a8 -5 -b -k -y -v -vi- -q -tWR -tWM -I../include -c
...
AFLAGS = /mx /w2 /zi
LFLAGS = -I..\..\..\win32\Release\obj -D"" -ap -Tpe -x -Gn -v -q
# ---------------------------------------------------------------------------
