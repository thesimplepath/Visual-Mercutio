...
// PSS_StateMachineCollection
//---------------------------------------------------------------------------
PSS_StateMachineCollection::PSS_StateMachineCollection(PSS_ProcessGraphModelMdl* pModel) :
    CObject(),
    m_pModel(pModel)
{}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void PSS_StateMachineCollection::AssignModel(PSS_ProcessGraphModelMdl* pModel)
{
    // assign the model
    m_pModel = pModel;
