...
// PSS_FieldTree
//---------------------------------------------------------------------------
PSS_FieldTree::PSS_FieldTree(ZITreeCtrl* pTreeCtrl, PSS_Document* pDoc, PSS_FieldRepository* pFieldRepository) :
...
//---------------------------------------------------------------------------
void PSS_FieldTree::Initialize(ZITreeCtrl* pTreeCtrl, PSS_Document* pDoc, PSS_FieldRepository* pFieldRepository)
{
    m_pTreeCtrl        = pTreeCtrl;
    m_pDoc             = pDoc;
    m_pFieldRepository = pFieldRepository;
