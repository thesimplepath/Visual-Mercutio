...
// PSS_ProjectTree
//---------------------------------------------------------------------------
PSS_ProjectTree::PSS_ProjectTree(PSS_TreeCtrl* pTreeCtrl, PSS_Document* pDoc, BOOL visibleOnly) :
    m_pDoc(pDoc),
...
//---------------------------------------------------------------------------
void PSS_ProjectTree::Initialize(PSS_TreeCtrl* pTreeCtrl, PSS_Document* pDoc, BOOL OnlyVisible)
{
    m_pDoc        = pDoc;
    m_pTreeCtrl   = pTreeCtrl;
