...
// PSS_UserTree
//---------------------------------------------------------------------------
PSS_UserTree::PSS_UserTree(ZITreeCtrl* pTreeCtrl, ZUUserManager* pUserManager) :
...
//---------------------------------------------------------------------------
void PSS_UserTree::Initialize(ZITreeCtrl* pTreeCtrl, ZUUserManager* pUserManager)
{
    m_pTreeCtrl    = pTreeCtrl;
    m_pUserManager = pUserManager;
...
//---------------------------------------------------------------------------
void PSS_UserTree::ReInitialize(ZUUserManager* pUserManager)
{
    m_pUserManager = pUserManager;
