...
inline void ZBPropertyItem::SetData(const CString sText)
{
    switch (m_Type)
    {
        ...
        case PI_DOUBLE:
        {
            ...
            if (PSS_StringFormatter::ConvertFormattedBuffer(sText, value, GetStringFormat()))
            {
                m_dValue = value;
            }
        ...
        case PI_DURATION:
        {
            ...
            if (PSS_StringFormatter::ConvertFormattedBuffer(sText, (PSS_Duration&)value, GetStringFormat()))
            {
        ...
        case PI_DATE:
        {
            ...
            if (PSS_StringFormatter::ConvertFormattedBuffer(sText, (PSS_Date&)value, GetStringFormat()))
            {
                m_dateValue = value;
            }
        ...
        case PI_TIME:
        {
            ...
            if (PSS_StringFormatter::ConvertFormattedBuffer(sText, (PSS_TimeSpan&)value, GetStringFormat()))
            {
                m_timeValue = value;
            }
...
inline CString ZBPropertyItem::GetData() const
{
    ...
    switch (m_Type)
    {
        ...
        case PI_DOUBLE:
        {
            ...
            sText = PSS_StringFormatter::GetFormattedBuffer(m_dValue,
        ...
        {
            // Format the value function of the string format specified
            sText = PSS_StringFormatter::GetFormattedBuffer(m_fValue,
                                                            const_cast<ZBPropertyItem*>(this)->GetStringFormat());
            break;
        }
        case PI_DURATION:
        {
            // Format the value function of the string format specified
            sText = PSS_StringFormatter::GetFormattedBuffer((PSS_Duration&)m_durationValue,
                                                            const_cast<ZBPropertyItem*>(this)->GetStringFormat());
            break;
        }
        case PI_DATE:
        {
            // Format the value function of the string format specified
            sText = PSS_StringFormatter::GetFormattedBuffer((PSS_Date&)m_dateValue,
                                                            const_cast<ZBPropertyItem*>(this)->GetStringFormat());
            break;
        }
        //RS-MODIF 08.08.2005 ajout de l'attribut dynamique "temps"
        ...
        {
            // Format the value function of the string format specified
            sText = PSS_StringFormatter::GetFormattedBuffer((PSS_TimeSpan&)m_timeValue,
                                                            const_cast<ZBPropertyItem*>(this)->GetStringFormat());
            break;
        }
    }
