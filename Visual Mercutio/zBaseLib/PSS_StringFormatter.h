...
class AFX_EXT_CLASS PSS_StringFormatter
{
    public:
        ...
        *@param buffer - formatted buffer to convert
        *@param[out] value - converted value on function ends, if succeeded
        *@param[in, out] fmt - string format
        *@return true on success, otherwise false
        */
    ...
    private:
        ...
        *@param[in, out] buffer - buffer in which the trailing zero should be removed
        *@param lcid - language identifier
        ...
        */
        static CString ConvertBufferToAmountBuffer(CString&                       buffer,
        ...
        *@return true on success, otherwise false
        */
        static bool ConvertBufferToNumber(CString&                        buffer,
                                          double&                         value,
                                          PSS_StringFormat::IEFormatType& sf,
                                          LPCTSTR                         pCurrency,
                                          LCID                            lcid);
