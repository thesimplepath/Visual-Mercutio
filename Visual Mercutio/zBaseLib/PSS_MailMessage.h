...
class AFX_EXT_CLASS PSS_MailMessage : public CObject
{
    ...
    public:
        ...
        *@return TRUE on success, otherwise FALSE
        */
        virtual inline BOOL AddFile(const CString& fileName, PSS_File::IEAttachmentType attachType = PSS_File::IEAttachmentType::IE_AT_InsertedFile);
        ...
        *@return TRUE on success, otherwise FALSE
        */
        virtual inline BOOL AddFile(PSS_File& file, PSS_File::IEAttachmentType attachType = PSS_File::IEAttachmentType::IE_AT_InsertedFile);
        ...
        *@param attachType - attachment type
        */
        virtual inline void FillFile(CStringArray& fileList, PSS_File::IEAttachmentType attachType = PSS_File::IEAttachmentType::IE_AT_InsertedFile);
        ...
        *@param attachType - attachment type
        */
        virtual inline void FillFile(PSS_FileManager& fileList, PSS_File::IEAttachmentType attachType = PSS_File::IEAttachmentType::IE_AT_InsertedFile);
        ...
        */
        virtual inline PSS_File::IEAttachmentType GetAttachmentType() const;
...
//---------------------------------------------------------------------------
BOOL PSS_MailMessage::AddFile(const CString& fileName, PSS_File::IEAttachmentType attachType)
{
    if (!m_pMailFileList)
...
//---------------------------------------------------------------------------
BOOL PSS_MailMessage::AddFile(PSS_File& file, PSS_File::IEAttachmentType attachType)
{
    if (!m_pMailFileList)
        m_pMailFileList = new PSS_MailFileDescription;
...
//---------------------------------------------------------------------------
void PSS_MailMessage::FillFile(CStringArray& fileList, PSS_File::IEAttachmentType attachType)
{
    if (!m_pMailFileList)
        m_pMailFileList = new PSS_MailFileDescription;
...
//---------------------------------------------------------------------------
void PSS_MailMessage::FillFile(PSS_FileManager& fileList, PSS_File::IEAttachmentType attachType)
{
    if (!m_pMailFileList)
        m_pMailFileList = new PSS_MailFileDescription;
...
//---------------------------------------------------------------------------
PSS_File::IEAttachmentType PSS_MailMessage::GetAttachmentType() const
{
    if (m_pMailFileList)
        return m_pMailFileList->GetAttachmentType();

    return PSS_File::IEAttachmentType::IE_AT_Undefined;
}
//---------------------------------------------------------------------------
