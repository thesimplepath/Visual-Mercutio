...
// Global variables
//---------------------------------------------------------------------------
static AFX_EXTENSION_MODULE g_ZReportBPDLL = {NULL, NULL};
//---------------------------------------------------------------------------
...
DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
    ...
    switch (dwReason)
    {
        case DLL_PROCESS_ATTACH:
            ...
            if (!::AfxInitExtensionModule(g_ZReportBPDLL, hInstance))
                return 0;
            ...
            new CDynLinkLibrary(g_ZReportBPDLL);
        ...
        case DLL_PROCESS_DETACH:
            ...
            ::AfxTermExtensionModule(g_ZReportBPDLL);
