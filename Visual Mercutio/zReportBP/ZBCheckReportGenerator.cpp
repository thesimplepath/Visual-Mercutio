...
IMPLEMENT_SERIAL( ZBCheckReportGenerator, ZBModelBPReportGenerator, def_Version )
...
void ZBCheckReportGenerator::FillGridUnitGroup( ZBUserGroupEntity* pGroup, ZBOStreamGrid &ostream )
{
	if ( !pGroup )
	{
		return;
