...
#ifndef PSS_SesterceUnitReportGeneratorH
#define PSS_SesterceUnitReportGeneratorH
...
#ifndef PSS_SesterceUnitReportGenerator
    #define PSS_SesterceUnitReportGenerator ZBSesterceUnitReportGenerator
#endif
...
/**
* Sesterce unit report generator
*@author Dominique Aigroz, Jean-Milost Reymond
*/
class AFX_EXT_CLASS PSS_SesterceUnitReportGenerator : public PSS_ModelBPReportGenerator
{
    DECLARE_SERIAL(PSS_SesterceUnitReportGenerator)
    ...
    public:
        ...
        */
        PSS_SesterceUnitReportGenerator(PSS_GridDocument*           pDoc               = NULL,
                                        PSS_ProcessGraphModelMdlBP* pModel             = NULL,
                                        PSS_ProcessGraphModelDoc*   pSourceDoc         = NULL,
                                        bool                        includeMonthDetail = true);

        virtual ~PSS_SesterceUnitReportGenerator();
