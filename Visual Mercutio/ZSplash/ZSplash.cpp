...
//---------------------------------------------------------------------------
static AFX_EXTENSION_MODULE g_zSplashDLL = {NULL, NULL};
//---------------------------------------------------------------------------
// DLL entry point
//---------------------------------------------------------------------------
...
DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
    ...
    switch (dwReason)
    {
        case DLL_PROCESS_ATTACH:
        {
            ...
            if (!AfxInitExtensionModule(g_zSplashDLL, hInstance))
                return 0;
            ...
            new CDynLinkLibrary(g_zSplashDLL);
        ...
        case DLL_PROCESS_DETACH:
        {
            ...
            AfxTermExtensionModule(g_zSplashDLL);
