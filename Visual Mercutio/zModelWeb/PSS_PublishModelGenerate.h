...
*/
class AFX_EXT_CLASS PSS_PublishModelGenerate : public ZIWizardDialog
{
public:
    /**
    * Dialog resources
    ...
    */
    virtual inline bool RequestCancel() const;
...
// PSS_PublishModelGenerate
//---------------------------------------------------------------------------
bool PSS_PublishModelGenerate::RequestCancel() const
{
