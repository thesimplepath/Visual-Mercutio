...
bool pPublishPrestations::Send()
{
    ...
    try
    {
        ...
        SOAPMethod pubPrestations(_T("pubPrestations"), PSS_SoapPublisher_Settings::m_ModelService.c_str(), _T("http://"));
        ...
        for (list<PSS_SoapData_Prestations>::iterator it = m_DataSet.begin(); it != m_DataSet.end(); ++it)
            prestations.Add(*it);
