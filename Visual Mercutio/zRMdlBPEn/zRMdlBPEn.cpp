...
// Global variables
//---------------------------------------------------------------------------
static AFX_EXTENSION_MODULE g_zRMdlBPEnDLL = {NULL, NULL};
//---------------------------------------------------------------------------
// DLL entry point
//---------------------------------------------------------------------------
...
DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
    ...
    switch (dwReason)
    {
        case DLL_PROCESS_ATTACH:
            ...
            if (!::AfxInitExtensionModule(g_zRMdlBPEnDLL, hInstance))
                return 0;
            ...
            new CDynLinkLibrary(g_zRMdlBPEnDLL);
        ...
        case DLL_PROCESS_DETACH:
            ...
            ::AfxTermExtensionModule(g_zRMdlBPEnDLL);
