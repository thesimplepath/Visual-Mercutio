    ...
    if ( ReportInfo != NULL )
    {
        if ( ReportInfo->DoExportConceptorReport == TRUE )
        {
            ZVPublishConceptorReport* m_pConceptorReportGenerator =
                new ZVPublishConceptorReport( dynamic_cast<ZDProcessGraphModelMdlBP*>( pDoc->GetModel() ),
        ...
        if ( ReportInfo->DoExportProcessReport == TRUE )
        {
            ZVPublishProcessReport* m_pProcessReportGenerator =
                new ZVPublishProcessReport( dynamic_cast<ZDProcessGraphModelMdlBP*>( pDoc->GetModel() ),
        ...
        if ( ReportInfo->DoExportPrestationsReport == TRUE )
        {
            ZVPublishPrestationsReport* m_pPrestationsReportGenerator =
                new ZVPublishPrestationsReport( dynamic_cast<ZDProcessGraphModelMdlBP*>( pDoc->GetModel() ) );
        ...
        if ( ReportInfo->DoExportRuleBook == TRUE )
        {
            ZVPublishRuleBook* m_pRuleBookGenerator =
                new ZVPublishRuleBook( dynamic_cast<ZDProcessGraphModelMdlBP*>( pDoc->GetModel() ) );
            ...
            ZVPublishRuleBookDetails* m_pRuleBookDetailsGenerator =
                new ZVPublishRuleBookDetails( dynamic_cast<ZDProcessGraphModelMdlBP*>( pDoc->GetModel() ) );
