...
// Global variables
//---------------------------------------------------------------------------
static AFX_EXTENSION_MODULE g_ZReportWebDLL = {NULL, NULL};
//---------------------------------------------------------------------------
...
DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
    ...
    switch (dwReason)
    {
        case DLL_PROCESS_ATTACH:
            ...
            if (!::AfxInitExtensionModule(g_ZReportWebDLL, hInstance))
                return 0;
            ...
            new CDynLinkLibrary(g_ZReportWebDLL);
        ...
        case DLL_PROCESS_DETACH:
            ...
            ::AfxTermExtensionModule(g_ZReportWebDLL);
