...
public:
    ...
    ZCInPlaceTimeEdit( ZBTimeSpan& TimeInitValue, bool IsReadOnly = false );
...
inline ZCInPlaceTimeEdit::ZCInPlaceTimeEdit( ZBTimeSpan& TimeInitValue, bool IsReadOnly /*= false*/ )
