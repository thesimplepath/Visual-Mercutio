...
{
    ZBToolbarObserverMsg Msg( UM_SHOWALLTYPES );
    NotifyAllObservers( &Msg );
}

void _ZIFlatToolBar::OnShowStaticTypeButton()
{
    ZBToolbarObserverMsg Msg( UM_SHOWSTATICTYPE );
    NotifyAllObservers( &Msg );
}

void _ZIFlatToolBar::OnShowDynamicTypeButton()
{
    ZBToolbarObserverMsg Msg( UM_SHOWDYNAMICTYPE );
    NotifyAllObservers( &Msg );
}
...
void ZVProperties::OnUpdate( ZISubject* pSubject, ZIObserverMsg* pMsg )
{
