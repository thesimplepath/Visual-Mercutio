...
{
public:
	CRectangle(ZCGridCtrl* pCtrl, CDC* pDC, int iIndent, const CRect& rcBounds);
	~CRectangle();
	void DrawRectangle(ZCGridCtrl *pCtrl);
...
//the nested class 
class ZCGridCtrl::CTreeItem : public CObject
{
