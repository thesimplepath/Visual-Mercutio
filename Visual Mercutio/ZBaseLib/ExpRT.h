...
class AFX_EXT_CLASS ZUDocumentExport : public ZUExport  //## Inherits: <unnamed>%36500BAE01AA
{
  ...
  public:
    //## Constructors (specified)
      ...
      //    document pointer
      ZUDocumentExport (CString Filename = "", ZDDocument* pDoc = NULL, BOOL GenerateHeader = FALSE, ESynchronizationSeparatorType SeparatorType = E_SS_Automatic, CString Schema = g_OriginalSchema, int PropagationMode = g_LocatePageOnly, BOOL EmptyWhenZero = FALSE, PSS_StatusBar* pStatusBar = NULL);
    ...
    //## Other Operations (specified)
      ...
      virtual void Create (CString Filename, ZDDocument* pDoc, BOOL GenerateHeader = FALSE, ESynchronizationSeparatorType SeparatorType = E_SS_Automatic, CString Schema = g_OriginalSchema, int PropagationMode = g_LocatePageOnly, BOOL EmptyWhenZero = FALSE, PSS_StatusBar* pStatusBar = NULL);
...
inline void ZUDocumentExport::Create (CString Filename, ZDDocument* pDoc, BOOL GenerateHeader, ESynchronizationSeparatorType SeparatorType, CString Schema, int PropagationMode, BOOL EmptyWhenZero, PSS_StatusBar* pStatusBar)
{
