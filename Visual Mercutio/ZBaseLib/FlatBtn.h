...
// Comment this if you don't want that ZCFlatButton hilights itself
// also when the window is inactive (like happens in Internet Explorer)
//#define ST_LIKEIE

// Comment this if you don't want to use ZMemoryDC class
//#define ST_USE_MEMDC
...
class AFX_EXT_CLASS ZCFlatButton : public CButton
{
// Construction
public:
    ZCFlatButton();
...
class ZMemoryDC : public CDC
{
public:

    // constructor sets up the memory DC
    ZMemoryDC(CDC* pDC) : CDC()
    {
        ASSERT(pDC != NULL);
    ...
    ZMemoryDC* operator->() {return this;}
        
    // Allow usage as a pointer
    operator ZMemoryDC*() {return this;}

private:
    CBitmap  m_bitmap;      // Offscreen bitmap
    CBitmap* m_pOldBitmap;  // bitmap originally found in ZMemoryDC
