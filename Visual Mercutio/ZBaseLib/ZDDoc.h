...
public:
    // Inherited feature
        ...
        const     BOOL     ShouldShowHiddenField () const { return m_bShowHiddenField; };
        void             SetShowHiddenField (BOOL value = TRUE) { m_bShowHiddenField = value; };
        const     BOOL     ShouldPrintLine () const { return( m_bPrintLine ); };
        void             SetPrintLine (BOOL value = TRUE) { m_bPrintLine = value; };
...
//      virtual CFormView* GetProcessView ();
      ...
      BOOL AddDocumentData (ZDDocumentData* pDocData);

      //## Operation: AddDocumentDataAfter%914146158
      //    Add a new document data after a specific position.
      BOOL AddDocumentDataAfter (ZDDocumentData* pDocData, int Index);
      ...
      virtual BOOL DeleteDocumentData (ZDDocumentData* pDocData);
  ...
  protected:
    ...
    //## Other Operations (specified)
      ...
      int GetDocumentDataIndex( ZDDocumentData* pDocData );
...
inline ZDDocumentData* ZDDocument::GetActiveDocumentData () const
{
...
inline ZDDocumentData* ZDDocument::GetDocumentDataAt (int DocumentIndex) const
{
  //## begin ZDDocument::GetDocumentDataAt%913885111.body preserve=yes
      if (DocumentIndex < (int)GetDocumentDataCount() && DocumentIndex >= 0)
          return (ZDDocumentData*)m_DocumentDataArray.GetAt( DocumentIndex );
    return NULL;
  //## end ZDDocument::GetDocumentDataAt%913885111.body
}

inline BOOL ZDDocument::AddDocumentData (ZDDocumentData* pDocData)
{
...
inline BOOL ZDDocument::AddDocumentDataAfter (ZDDocumentData* pDocData, int Index)
{
