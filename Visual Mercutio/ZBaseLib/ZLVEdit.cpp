// ZLVEdit.cpp : implementation of the CListEditView class
//
...
/////////////////////////////////////////////////////////////////////////////
// ZLVEdit
BEGIN_MESSAGE_MAP(ZLVEdit, CEdit)
	//{{AFX_MSG_MAP(ZLVEdit)
	ON_WM_KILLFOCUS()
	ON_WM_NCDESTROY()
	ON_WM_CHAR()
...
/////////////////////////////////////////////////////////////////////////////
// ZLVEdit message handlers

ZLVEdit::ZLVEdit(int iItem, int iSubItem, CString sInitText)
: m_strInitText(sInitText), m_x(0), m_y(0)
{	
	m_iItem = iItem;
	m_iSubItem = iSubItem;
	m_bVK_ESCAPE = 0;
...
int ZLVEdit::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
BOOL ZLVEdit::PreTranslateMessage(MSG* pMsg)
{
...
void ZLVEdit::OnKillFocus(CWnd* pNewWnd)
{	
...
void ZLVEdit::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags)
{
...
void ZLVEdit::OnWindowPosChanging(WINDOWPOS FAR* lpwndpos) 
{
	lpwndpos->x=m_x;
	lpwndpos->y=m_y;
