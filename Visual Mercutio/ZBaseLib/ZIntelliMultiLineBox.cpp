...
ZIntelliMultiLineBox::ZIntelliMultiLineBox(ZCMultiLineEdit* pEditCtrl /*= NULL*/, CSize* pSize /*= NULL*/)
...
BOOL ZIntelliMultiLineBox::Create( ZCMultiLineEdit* pEditCtrl, CSize* pSize /*= NULL*/ )
{
    ASSERT( pEditCtrl );
...
void ZIntelliMultiLineBox::SetEditControl( ZCMultiLineEdit* pEditCtrl, CSize* pSize /*= NULL*/ )
{
    m_pEditCtrl = pEditCtrl;
...
_ZCInternalMultiLineEdit::_ZCInternalMultiLineEdit(ZCMultiLineEdit* pEditCtrl /*= NULL*/, ZIntelliMultiLineBox* pParent /*= NULL*/)
...
void _ZCInternalMultiLineEdit::SetEditControl( ZCMultiLineEdit* pEditCtrl, ZIntelliMultiLineBox* pParent /*= NULL*/ )
{
    m_pEditCtrl = pEditCtrl;
    if (pParent)
        m_pParent = pParent;
