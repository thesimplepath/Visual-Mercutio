...
void ZCFlatButton::SetFlat(BOOL bState)
{
  m_bIsFlat = bState;
  Invalidate();
} // End of SetFlat
...
BOOL ZCFlatButton::GetFlat()
{
  return m_bIsFlat;
} // End of GetFlat


void ZCFlatButton::SetAlign(int nAlign)
{
  switch (nAlign)
  {    
    case ST_ALIGN_HORIZ:
...
int ZCFlatButton::GetAlign()
{
  return m_nAlign;
} // End of GetAlign


void ZCFlatButton::DrawBorder(BOOL bEnable)
{
  m_bDrawBorder = bEnable;
} // End of DrawBorder


const char* ZCFlatButton::GetVersionC()
{
  return "2.6";
} // End of GetVersionC


const short ZCFlatButton::GetVersionI()
{
  return 26; // Divide by 10 to get actual version
} // End of GetVersionI


void ZCFlatButton::SetShowText(BOOL bShow)
{
  m_bShowText = bShow;
  Invalidate();
} // End of SetShowText
...
void ZCFlatButton::OnKillFocus(CWnd * pNewWnd)
{
...
void ZCFlatButton::DrawItem(LPDRAWITEMSTRUCT lpDIS)
{
#ifdef ST_USE_MEMDC
