...
class AFX_EXT_CLASS ZUUserExport : public ZUExport  //## Inherits: <unnamed>%36F7BC4E001F
{
  ...
  public:
    //## Constructors (specified)
      ...
      ZUUserExport (CString Filename = "", ZUUserManager* pUserManager = NULL, BOOL GenerateHeader = FALSE, ESynchronizationSeparatorType SeparatorType = E_SS_Automatic, CString Schema = g_OriginalSchema, int PropagationMode = g_LocatePageOnly, BOOL EmptyWhenZero = FALSE, PSS_StatusBar* pStatusBar = NULL);
    ...
    //## Other Operations (specified)
      ...
      virtual void Create (CString Filename, ZUUserManager* pUserManager = NULL, BOOL GenerateHeader = FALSE, ESynchronizationSeparatorType SeparatorType = E_SS_Automatic, CString Schema = g_OriginalSchema, int PropagationMode = g_LocatePageOnly, BOOL EmptyWhenZero = FALSE, PSS_StatusBar* pStatusBar = NULL);
...
inline void ZUUserExport::Create(CString Filename, ZUUserManager* pUserManager, BOOL GenerateHeader, ESynchronizationSeparatorType SeparatorType, CString Schema, int PropagationMode, BOOL EmptyWhenZero, PSS_StatusBar* pStatusBar)
{
