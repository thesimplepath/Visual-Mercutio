...
{
public:
    ZDHistoryFolderStatusRecordset(CDaoDatabase* pDatabase = NULL, CString DatabaseFilename = "");
    DECLARE_DYNAMIC(ZDHistoryFolderStatusRecordset)
...
private:
// Field/Param Data
    //{{AFX_FIELD(ZDHistoryFolderStatusRecordset, CDaoRecordset)
...
// Overrides
    ...
    //{{AFX_VIRTUAL(ZDHistoryFolderStatusRecordset)
    public:
...
#endif // !defined(AFX_HistoryFolderStatusRecordSet_H__293D9E4D_F146_11D3_96DD_0000B45D7C6F__INCLUDED_)
