...
#ifndef PSS_ReassignDynamicAttributesToModelH
#define PSS_ReassignDynamicAttributesToModelH
...
/**
* Navigates through the model and reassigns the property object to symbols
*@author Dominique Aigroz, Jean-Milost Reymond
*/
class AFX_EXT_CLASS PSS_ReassignDynamicAttributesToModel : public PSS_ModelNavigation
{
    public:
        /**
        * Constructor
