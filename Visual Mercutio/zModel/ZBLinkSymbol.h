...
inline bool ZBLinkSymbol::OnToolTip(CString& toolTipText, const CPoint& point, PSS_ToolTip::IEToolTipMode mode)
{
    return false;
}

inline CString ZBLinkSymbol::GetReferenceName() const
{
    return m_NameOfReference;
}

inline void ZBLinkSymbol::SetReferenceName(const CString& value)
{
