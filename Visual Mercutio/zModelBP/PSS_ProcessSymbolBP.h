...
class AFX_EXT_CLASS PSS_ProcessSymbolBP : public PSS_Symbol
{
    ...
    public:
        ...
        *@param[in, out] refresh - if true, the symbol will be refreshed immediately after the process is terminated
        */
        virtual void OnDelCurrentPrestation(PSS_Property& prop, CString& value, PSS_Properties::IPropertySet& props, bool& refresh);
    ...
    private:
        ...
        */
        CString GetPossibleListOfMainDeliverables(const PSS_Properties::IPropertySet& propSet, int catID) const;
        ...
        */
        CString GetAvailableDeliverables(const PSS_Properties::IPropertySet& propSet) const;
        ...
        *@param[in, out] refresh - if true, the symbol will be refreshed immediately after the process is terminated
        */
        void OnAddNewRisk(PSS_Property& prop, CString& value, PSS_Properties::IPropertySet& props, bool& refresh);
        ...
        *@param[in, out] refresh - if true, the symbol will be refreshed immediately after the process is terminated
        */
        void OnDelCurrentRisk(PSS_Property& prop, CString& value, PSS_Properties::IPropertySet& props, bool& refresh);
        ...
        *@param[in, out] refresh - if true, the symbol will be refreshed immediately after the process is terminated
        */
        void OnAddNewDelivery(PSS_Property& prop, CString& value, PSS_Properties::IPropertySet& props, bool& refresh);
        ...
        *@param[in, out] refresh - if true, the symbol will be refreshed immediately after the process is terminated
        */
        void OnDelCurrentDelivery(PSS_Property& prop, CString& value, PSS_Properties::IPropertySet& props, bool& refresh);
};
