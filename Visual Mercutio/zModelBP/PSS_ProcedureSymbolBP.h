...
class AFX_EXT_CLASS PSS_ProcedureSymbolBP : public PSS_Symbol
{
    ...
    public:
        ...
        */
        virtual bool OnPostPropertyChanged(PSS_Property& property, PSS_Properties::IPropertySet& properties, bool& refresh);
    ...
    protected:
        ...
        *@param[in, out] refresh - if true, the symbol will be refreshed immediately
        */
        virtual void OnAddNewCombination(PSS_Property& prop, CString& value, PSS_Properties::IPropertySet& props, bool& refresh);
        ...
        *@param[in, out] refresh - if true, the symbol will be refreshed immediately
        */
        virtual void OnDelCurrentCombination(PSS_Property&                 prop,
                                             CString&                      value,
                                             PSS_Properties::IPropertySet& props,
                                             bool&                         refresh);
        ...
        *@param[in, out] refresh - if true, the symbol will be refreshed immediately
        */
        virtual void OnAddDeliverableCombination(PSS_Property&                 prop,
                                                 CString&                      value,
                                                 PSS_Properties::IPropertySet& props,
                                                 bool&                         refresh);
        ...
        *@param[in, out] refresh - if true, the symbol will be refreshed immediately
        */
        virtual void OnDelDeliverableCombination(PSS_Property&                 prop,
                                                 CString&                      value,
                                                 PSS_Properties::IPropertySet& props,
                                                 bool&                         refresh);
        ...
        *@param[in, out] refresh - if true, the symbol will be refreshed immediately
        */
        virtual void OnAddNewRisk(PSS_Property& prop, CString& value, PSS_Properties::IPropertySet& props, bool& refresh);
        ...
        *@param[in, out] refresh - if true, the symbol will be refreshed immediately
        */
        virtual void OnDelCurrentRisk(PSS_Property& prop, CString& value, PSS_Properties::IPropertySet& props, bool& refresh);
