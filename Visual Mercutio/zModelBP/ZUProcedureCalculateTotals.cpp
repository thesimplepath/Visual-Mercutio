...
bool ZUProcedureCalculateTotals::OnStartSymbol(PSS_StartSymbolBP* pSymbol)
{
    return true;
}

bool ZUProcedureCalculateTotals::OnStopSymbol(PSS_StopSymbolBP* pSymbol)
{
    return true;
}

bool ZUProcedureCalculateTotals::OnDeliverableLinkSymbol(PSS_DeliverableLinkSymbolBP* pSymbol)
{
    return true;
}
