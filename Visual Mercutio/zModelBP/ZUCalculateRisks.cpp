...
bool ZUCalculateRisks::CheckProcedureSymbol(PSS_ProcedureSymbolBP* pSymbol)
{
    ASSERT(pSymbol);
...
bool ZUCalculateRisks::CheckProcessSymbol(PSS_ProcessSymbolBP* pSymbol)
{
    ASSERT(pSymbol);
...
bool ZUCalculateRisks::CheckStartSymbol(PSS_StartSymbolBP* pSymbol)
{
    ASSERT(pSymbol);
...
bool ZUCalculateRisks::CheckDeliverableLinkSymbol(PSS_DeliverableLinkSymbolBP* pSymbol)
{
    ASSERT(pSymbol);
