...
//---------------------------------------------------------------------------
void PSS_CostPropertiesProcedureBP_Beta1::Merge(CODProperty* pProperty, DWORD changeFlags)
{
    PSS_CostPropertiesProcedureBP_Beta1* pOrientationProp = dynamic_cast<PSS_CostPropertiesProcedureBP_Beta1*>(pProperty);
