...
IMPLEMENT_SERIAL(ZBBPProcessSymbol, PSS_Symbol, g_DefVersion)
...
BOOL ZBBPProcessSymbol::Create(const CString Name /*= ""*/)
{
    ...
    BOOL RetValue = PSS_Symbol::Create(IDR_BP_PROCESS,
...
CString ZBBPProcessSymbol::GetRuleNameByGUID(PSS_LogicalRulesEntity* p_Rule, CString RuleGUID)
{
    if (p_Rule == NULL)
    {
        return _T("");
