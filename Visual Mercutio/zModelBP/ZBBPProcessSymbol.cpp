		 ...
		 dynamic_cast<ZDProcessGraphModelMdl*>( pModel )->GetIntegrateCostSimulation() )
	{
		...
		else
		{
			...
			pSimProp = new ZBProperty( IDS_ZS_BP_PROP_SIM_PROCESS,
									   ...
									   Z_SIM_PROCESS_WORKLOAD_FORECAST,
									   IDS_Z_SIM_PROCESS_WORKLOAD_FORECAST_DESC,
									   ZBDuration( (double)GetProcessWorkloadForecast(),
...
//								   ZBProperty::PT_EDIT_NUMBER_READONLY );
								   ZBDuration( (double)m_WorkloadByDeliveries,
											   HourPerDay,
											   DayPerWeek,
											   DayPerMonth,
											   DayPerYear ),
...
bool ZBBPProcessSymbol::OnToolTip( CString& ToolTipText, CPoint point, ToolTipMode ToolTip /*= NormalToolTip*/ )
{
