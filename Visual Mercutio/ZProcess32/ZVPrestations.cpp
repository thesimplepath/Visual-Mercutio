...
{
	ZBToolbarObserverMsg Msg( UM_PRS_ADDPRESTATION );
...
{
	ZBToolbarObserverMsg Msg( UM_PRS_MOVEPRESTATION );
	NotifyAllObservers( &Msg );
}

void _ZIPrestationsFlatToolBar::OnPropertiesButton()
{
	ZBToolbarObserverMsg Msg( UM_PRS_PROPERTIES );
	NotifyAllObservers( &Msg );
}

void _ZIPrestationsFlatToolBar::OnRefreshButton()
{
	ZBToolbarObserverMsg Msg( UM_PRS_REFRESH );
	NotifyAllObservers( &Msg );
}
...
void ZVPrestations::OnUpdate( ZISubject* pSubject, ZIObserverMsg* pMsg )
{
