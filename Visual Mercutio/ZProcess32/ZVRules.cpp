...
{
	ZBToolbarObserverMsg Msg( UM_RUL_ADDRULE );
...
{
	ZBToolbarObserverMsg Msg( UM_RUL_MOVERULE );
	NotifyAllObservers( &Msg );
}

void _ZIRulesFlatToolBar::OnPropertiesButton()
{
	ZBToolbarObserverMsg Msg( UM_RUL_PROPERTIES );
	NotifyAllObservers( &Msg );
}

void _ZIRulesFlatToolBar::OnRefreshButton()
{
	ZBToolbarObserverMsg Msg( UM_RUL_REFRESH );
	NotifyAllObservers( &Msg );
}
...
void ZVRules::OnUpdate( ZISubject* pSubject, ZIObserverMsg* pMsg )
{
