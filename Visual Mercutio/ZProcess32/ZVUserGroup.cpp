...
{
	ZBToolbarObserverMsg Msg( UM_UGP_ADDGROUP );
...
{
	ZBToolbarObserverMsg Msg( UM_UGP_ADDROLE );
	NotifyAllObservers( &Msg );
}

void _ZIUserGroupFlatToolBar::OnRenameRoleButton()
{
	ZBToolbarObserverMsg Msg( UM_UGP_RENAMEROLE );
	NotifyAllObservers( &Msg );
}

void _ZIUserGroupFlatToolBar::OnDeleteRoleButton()
{
	ZBToolbarObserverMsg Msg( UM_UGP_DELETEROLE );
	NotifyAllObservers( &Msg );
}

void _ZIUserGroupFlatToolBar::OnPropertiesButton()
{
	ZBToolbarObserverMsg Msg( UM_UGP_PROPERTIES );
	NotifyAllObservers( &Msg );
}

void _ZIUserGroupFlatToolBar::OnMoveButton()
{
	ZBToolbarObserverMsg Msg( UM_UGP_MOVE );
	NotifyAllObservers( &Msg );
}

void _ZIUserGroupFlatToolBar::OnRefreshButton()
{
	ZBToolbarObserverMsg Msg( UM_UGP_REFRESH );
	NotifyAllObservers( &Msg );
...
void ZVUserGroup::OnUpdate( ZISubject* pSubject, ZIObserverMsg* pMsg )
{
