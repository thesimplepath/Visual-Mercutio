 ...
 * ==> Class Table_TState ---------------------------------------------------*
 * ***************************************************************************
 * Description : Manage database operations specialized for T_State table.   *
 * Version     : 1.0                                                         *
...
{
    class Table_TState : ITable
    {
        #region Global variables

        private string                m_TableName     = "T_State";
        private string                m_SelectColumns = "StateID, [Name]";
        private string                m_SelectParams  = "StateID";
        private string                m_InsertColumns = "[Name]";
        private string                m_InsertParams  = "?";
        private string                m_UpdateColumns = "[Name] = ?";
        private string                m_UpdateParams  = "(StateID = ?) AND ([Name] = ? OR ? IS NULL AND [Name] IS NULL)";
        private string                m_DeleteParams  = "(StateID = ?) AND ([Name] = ? OR ? IS NULL AND [Name] IS NULL)";
        ...
        public Table_TState( OleDatabaseConnection Connection )
        {
            ...
            m_TraceSwitch   = new TraceSwitch( "Table_TStateTrace", "Trace the T_Case table messages." );
        }
        ...
        public bool Connect()
        {
            ...
            try
            {
                ...
                m_UpdateCommand.Parameters.Add( new OleDbParameter( "Original_StateID", OleDbType.Integer,  0,  ParameterDirection.Input, false, ( (Byte)( 0 ) ), ( (Byte)( 0 ) ), "StateID", DataRowVersion.Original, null ) );
                ...
                m_DeleteCommand.Parameters.Add( new OleDbParameter( "Original_StateID", OleDbType.Integer,  0,  ParameterDirection.Input, false, ( (Byte)( 0 ) ), ( (Byte)( 0 ) ), "StateID", DataRowVersion.Original, null ) );
