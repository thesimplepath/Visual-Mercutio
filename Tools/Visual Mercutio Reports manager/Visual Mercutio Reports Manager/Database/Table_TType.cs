 ...
 * ==> Class Table_TType ----------------------------------------------------*
 * ***************************************************************************
 * Description : Manage database operations specialized for T_Type table.    *
 * Version     : 1.0                                                         *
...
{
    class Table_TType : ITable
    {
        #region Global variables

        private string                m_TableName     = "T_Type";
        private string                m_SelectColumns = "TypeID, [Name]";
        private string                m_SelectParams  = "TypeID";
        private string                m_InsertColumns = "[Name]";
        private string                m_InsertParams  = "?";
        private string                m_UpdateColumns = "[Name] = ?";
        private string                m_UpdateParams  = "(TypeID = ?) AND ([Name] = ? OR ? IS NULL AND [Name] IS NULL)";
        private string                m_DeleteParams  = "(TypeID = ?) AND ([Name] = ? OR ? IS NULL AND [Name] IS NULL)";
        ...
        public Table_TType( OleDatabaseConnection Connection )
        {
            ...
            m_TraceSwitch   = new TraceSwitch( "Table_TTypeTrace", "Trace the T_Case table messages." );
        }
        ...
        public bool Connect()
        {
            ...
            try
            {
                ...
                m_UpdateCommand.Parameters.Add( new OleDbParameter( "Original_TypeID", OleDbType.Integer,  0,  ParameterDirection.Input, false, ( (Byte)( 0 ) ), ( (Byte)( 0 ) ), "TypeID", DataRowVersion.Original, null ) );
                ...
                m_DeleteCommand.Parameters.Add( new OleDbParameter( "Original_TypeID", OleDbType.Integer,  0,  ParameterDirection.Input, false, ( (Byte)( 0 ) ), ( (Byte)( 0 ) ), "TypeID",  DataRowVersion.Original, null ) );
