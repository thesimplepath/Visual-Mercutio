 ...
 * ==> Class ModifyCase -----------------------------------------------------*
 * ***************************************************************************
 * Description : Form to modify TCase table.                                 *
 * Version     : 1.0                                                         *
...
{
    public partial class ModifyCase: Form
    {
        ...
        /// Default constructor.
        /// </summary>
        public ModifyCase( MessageDisplayer Value )
        {
            InitializeComponent();

            m_MessageDisplayer = Value;

            m_TraceSwitch = new TraceSwitch( "ModifyCaseTrace", "Trace switch for Case Table modifier form." );
        }
        ...
        /// <param name="e"></param>
        private void dgvCase_DataError( object sender, DataGridViewDataErrorEventArgs e )
        {
            // Trace begin function message
            if ( m_TraceSwitch.TraceInfo )
            {
