 ...
 * ==> Class ModifyType -----------------------------------------------------*
 * ***************************************************************************
 * Description : Form to modify TType table.                                 *
 * Version     : 1.0                                                         *
...
namespace Visual_Mercutio_Reports_Manager.Forms
{
    public partial class ModifyType : Form
    {
        ...
        /// Default constructor.
        /// </summary>
        public ModifyType( MessageDisplayer Value )
        {
            InitializeComponent();

            m_MessageDisplayer = Value;

            m_TraceSwitch = new TraceSwitch( "ModifyTypeTrace", "Trace switch for OS Table modifier form." );
        }
