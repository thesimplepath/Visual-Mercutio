 ...
 * ==> Class ModifyOS -------------------------------------------------------*
 * ***************************************************************************
 * Description : Form to modify TOperatingSystems table.                     *
 * Version     : 1.0                                                         *
...
{
    public partial class ModifyOS : Form
    {
        ...
        /// Default constructor.
        /// </summary>
        public ModifyOS( MessageDisplayer Value )
        {
            InitializeComponent();

            m_MessageDisplayer = Value;

            m_TraceSwitch = new TraceSwitch( "ModifyOSTrace", "Trace switch for OS Table modifier form." );
        }
