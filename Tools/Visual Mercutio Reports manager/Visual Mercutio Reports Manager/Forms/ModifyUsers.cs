 ...
 * ==> Class ModifyUsers ----------------------------------------------------*
 * ***************************************************************************
 * Description : Form to modify TUsers table.                                *
 * Version     : 1.0                                                         *
...
namespace Visual_Mercutio_Reports_Manager.Forms
{
    public partial class ModifyUsers : Form
    {
        ...
        /// Default constructor.
        /// </summary>
        public ModifyUsers( MessageDisplayer Value )
        {
            InitializeComponent();

            m_MessageDisplayer = Value;

            m_TraceSwitch = new TraceSwitch( "ModifyUsersTrace", "Trace switch for OS Table modifier form." );
        }
