...
{
    public partial class FrmIndicProducTeam : Form
    {
        ...
        private void cmdQuery_Click_1(object sender, EventArgs e)
        {
            ...
            grdPreview.DataSource = m_Indic.QueryIndicatorProductivityTeam(m_WkgID, m_Year, m_ModelID, cboCalendar.SelectedIndex);
