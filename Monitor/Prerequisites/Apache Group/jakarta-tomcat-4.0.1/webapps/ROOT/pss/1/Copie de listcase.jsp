    ...
    <TD class=NormalBlack vAlign=top width="89%" >
      <TABLE class=Mtable id=MsgTable cellSpacing=0 cellPadding=0 
        ...
        <TR bgColor=#336699>
          ...
          <TD width="41%"><NOBR><A title="Trier par expéditeur" 
            href=""><FONT 
            class=swb 
            color=#ffffff>Livrable de la combinaison</FONT></A></NOBR><NOBR></NOBR><NOBR>&nbsp;</NOBR></TD>
          <TD width="29%"><NOBR><A title="Trier par procedure" 
            href=""><FONT 
            class=swb 
            color=#ffffff>Procedure</FONT></A></NOBR><NOBR></NOBR><NOBR>&nbsp;</NOBR></TD>
          <TD width="10%" bgColor=#93bee2><NOBR><A title="Trier par date" 
            href=""><IMG 
...
/*
	...
	*/
	...
	out.println("<TD width=\"3%\"><INPUT onclick=doChangeStatus(1,"+rs.getInt("procid")+","+rs.getInt("transid")+","+statuschangeid+"); type=checkbox "+checked+"> </TD>");
      	out.println("<TD width=\"17%\">"+statusname+"</TD>");
      	out.println("<TD width=\"29%\"><A href=\""+plink+"\">"+livrables+"</A></TD>");
      	out.println("<TD width=\"24%\"><A href=\""+plink+"\">"+procname+"</A></TD>");
