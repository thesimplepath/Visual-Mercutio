...
<%
 ...
 rs=conn.sqlQueryR("SELECT * FROM pdeliv,pdelivattr WHERE pdeliv.delivid="+delivid+" AND pdeliv.delivattribid=pdelivattr.delivattribid AND attribdefid>=60 AND attribdefid<=79");
...
<%
 ...
 rs=conn.sqlQueryR("SELECT pdelivattr.attribdefid as attribdefid,pdelivattr.mvalue as mvalue FROM pdeliv,pdelivattr WHERE pdeliv.delivid="+delivid+" AND pdeliv.delivattribid=pdelivattr.delivattribid AND pdelivattr.attribdefid in (9,10)");
