...
for (j=0;j<menu_level;j++) spc=spc+="&nbsp;&nbsp;&nbsp;";
			...
			if (dta.urlmenu!=null)
				document.writeln("<div id=Q"+ dta.refid +" style=\"cursor:hand; width:160px;\" nowrap class=\""+st+"\" valign=\"top\">"+spc+"<img src=\""+this.icondoc+"\">&nbsp;<a href=\""+ dta.urlmenu +"\" target=doc title=\"Go to "+dta.txtmenu+"\">"+dta.txtmenu +"</a></div>");
