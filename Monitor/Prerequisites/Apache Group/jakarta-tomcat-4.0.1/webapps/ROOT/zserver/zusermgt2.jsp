...
<input type=button value="&nbsp;&nbsp;&gt;&nbsp;&gt;&nbsp;&nbsp;" onclick="javascript:document.location='zusermgt2.jsp?MODE=1&WKGID=<%=wkgid%>&LOGIN='+escape(EMP.value);">
<br><br>
<input type=button value="&nbsp;&nbsp;&lt;&nbsp;&lt;&nbsp;&nbsp;" onclick="javascript:document.location='zusermgt2.jsp?MODE=2&WKGID=<%=wkgid%>&LOGIN='+escape(MAP.value);">
</td>
