...
public class stats$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/emessenger/stats.jsp";from=(0,0);to=(1,0)]
                out.write("<html>\r\n");

            // end
            // HTML // begin [file="/emessenger/stats.jsp";from=(1,26);to=(3,0)]
                out.write("\r\n<META http-equiv=Content-Type content=\"text/html; charset=utf-8\">\r\n");

            // end
            // begin [file="/emessenger/stats.jsp";from=(3,0);to=(3,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/emessenger/stats.jsp";from=(3,53);to=(5,40)]
                out.write("\r\n<script language=Javascript>\r\ntop.showTabText(9,\"Utilisateur:</td><td>");

            // end
            // begin [file="/emessenger/stats.jsp";from=(5,43);to=(5,83)]
                out.print((String)session.getAttribute("USERNAME"));
            // end
            // HTML // begin [file="/emessenger/stats.jsp";from=(5,85);to=(17,0)]
