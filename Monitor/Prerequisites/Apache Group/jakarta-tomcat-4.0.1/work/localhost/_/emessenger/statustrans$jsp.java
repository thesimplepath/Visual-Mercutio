...
public class statustrans$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/emessenger/statustrans.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<html>\r\n");

            // end
            // HTML // begin [file="/emessenger/statustrans.jsp";from=(1,76);to=(2,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/emessenger/statustrans.jsp";from=(2,26);to=(4,0)]
                out.write("\r\n<META http-equiv=Content-Type content=\"text/html; charset=utf-8\">\r\n");

            // end
            // begin [file="/emessenger/statustrans.jsp";from=(4,0);to=(4,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/emessenger/statustrans.jsp";from=(4,53);to=(7,0)]
                out.write("\r\n<SCRIPT LANGUAGE=\"JavaScript\">\r\n<!--\t\r\n");

            // end
            // begin [file="/emessenger/statustrans.jsp";from=(7,2);to=(21,0)]
            ...
            // end
            // HTML // begin [file="/emessenger/statustrans.jsp";from=(21,2);to=(23,21)]
                out.write("\r\n\r\ndocument.location = \"");

            // end
            // begin [file="/emessenger/statustrans.jsp";from=(23,24);to=(23,29)]
                out.print(redir);
            // end
            // HTML // begin [file="/emessenger/statustrans.jsp";from=(23,31);to=(27,20)]
                out.write("\";\r\n// --> \r\n</SCRIPT>\r\n\r\n<body></body></html>");
