...
public class newproc2$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<html>\r\n");

            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(1,88);to=(2,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(2,26);to=(5,0)]
                out.write("\r\n<head>\r\n<META http-equiv=Content-Type content=\"text/html; charset=utf-8\">\r\n");

            // end
            // begin [file="/emessenger/newproc2.jsp";from=(5,0);to=(5,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(5,53);to=(6,0)]
                out.write("\r\n");

            // end
            // begin [file="/emessenger/newproc2.jsp";from=(6,2);to=(8,0)]
                
                 String userskin="skin"+(String)session.getAttribute("USERSKIN");
            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(8,2);to=(9,16)]
                out.write("\r\n<link href=\"css/");

            // end
            // begin [file="/emessenger/newproc2.jsp";from=(9,19);to=(9,27)]
                out.print(userskin);
            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(9,29);to=(14,0)]
                out.write("/global.css\" rel=\"styleSheet\" type=\"text/css\">\r\n<script language=JavaScript src=\"js/pss.js\"></script>\r\n</head>\r\n<BODY>\r\n<TABLE width=\"100%\" border=0>\r\n");

            // end
            // begin [file="/emessenger/newproc2.jsp";from=(14,2);to=(30,2)]
            ...
            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(30,4);to=(34,68)]
                out.write("\r\n  <TBODY>\r\n  <TR>\r\n  \t<TD width=\"11%\">&nbsp;</TD>\r\n  \t<TD class=NormalBlack vAlign=top width=\"89%\">Nouveau cas crÃ©Ã©: ");

            // end
            // begin [file="/emessenger/newproc2.jsp";from=(34,71);to=(34,79)]
                out.print(casename);
            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(34,81);to=(34,83)]
                out.write(", ");

            // end
            // begin [file="/emessenger/newproc2.jsp";from=(34,86);to=(34,95)]
                out.print(transname);
            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(34,97);to=(39,0)]
                out.write("</TD>\r\n  </TR>\r\n  <TR>\r\n  \t<TD width=\"11%\">&nbsp;</TD>\r\n  \t<TD class=NormalBlack vAlign=top width=\"89%\"><P>&nbsp;</P><P>Le message a Ã©tÃ© envoyÃ© dans la boÃ®te de travail de la procÃ©dure:</P>\r\n");

            // end
            // begin [file="/emessenger/newproc2.jsp";from=(39,2);to=(45,1)]
            ...
            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(45,3);to=(46,8)]
                out.write("\r\n\t\t<P><B>");

            // end
            // begin [file="/emessenger/newproc2.jsp";from=(46,11);to=(46,36)]
                out.print(rs.getString("delivname"));
            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(46,38);to=(47,1)]
                out.write("</B></P></TD></TR>\r\n\t");

            // end
            // begin [file="/emessenger/newproc2.jsp";from=(47,3);to=(70,0)]
            ...
            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(70,2);to=(82,32)]
            ...
            // end
            // begin [file="/emessenger/newproc2.jsp";from=(82,35);to=(82,41)]
                out.print(caseid);
            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(82,43);to=(82,51)]
                out.write("&PROCID=");

            // end
            // begin [file="/emessenger/newproc2.jsp";from=(82,54);to=(82,60)]
                out.print(procid);
            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(82,62);to=(82,71)]
                out.write("&TRANSID=");

            // end
            // begin [file="/emessenger/newproc2.jsp";from=(82,74);to=(82,81)]
                out.print(transid);
            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(82,83);to=(87,0)]
                out.write("\";\r\n\tdocument.location=url;\r\n\treturn false;\r\n}\r\n</script>\r\n");

            // end
            // begin [file="/emessenger/newproc2.jsp";from=(87,2);to=(93,0)]
            ...
            // end
            // HTML // begin [file="/emessenger/newproc2.jsp";from=(93,2);to=(95,7)]
                out.write("\r\n</body>\r\n</html>");
