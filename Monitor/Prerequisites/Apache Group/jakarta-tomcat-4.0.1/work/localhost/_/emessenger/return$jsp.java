...
public class return$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/emessenger/return.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<html>\r\n");

            // end
            // HTML // begin [file="/emessenger/return.jsp";from=(1,115);to=(2,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/emessenger/return.jsp";from=(2,26);to=(5,0)]
                out.write("\r\n<head>\r\n<META http-equiv=Content-Type content=\"text/html; charset=utf-8\">\r\n");

            // end
            // begin [file="/emessenger/return.jsp";from=(5,0);to=(5,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/emessenger/return.jsp";from=(5,53);to=(16,0)]
                out.write("\r\n<link href=\"css/doc.css\" rel=\"styleSheet\" type=\"text/css\"> \r\n<script language=JavaScript src=\"js/pss.js\"></script>\r\n\r\n<script language=JavaScript>\r\n<!--\r\n//-->\r\n</script>\r\n</head>\r\n\r\n<body>\r\n");

            // end
            // begin [file="/emessenger/return.jsp";from=(16,2);to=(84,0)]
                ...
                try {
                	...
                	if (foundParent==true)
                	{
                		...
                		conn2.sqlExecR("DELETE FROM psystemcestatus WHERE procid="+procid+" AND caseid="+caseid+" AND transid="+transid);
                ...
                out.println("</script>");
            // end
            // HTML // begin [file="/emessenger/return.jsp";from=(84,2);to=(86,7)]
                out.write("\r\n</body>\r\n</html>");
