...
public class setdecision$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/emessenger/setdecision.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<html>\r\n");

            // end
            // HTML // begin [file="/emessenger/setdecision.jsp";from=(1,49);to=(2,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/emessenger/setdecision.jsp";from=(2,26);to=(5,0)]
                out.write("\r\n<head>\r\n<META http-equiv=Content-Type content=\"text/html; charset=utf-8\">\r\n");

            // end
            // begin [file="/emessenger/setdecision.jsp";from=(5,0);to=(5,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/emessenger/setdecision.jsp";from=(5,53);to=(10,0)]
                out.write("\r\n<link href=\"css/doc.css\" rel=\"styleSheet\" type=\"text/css\"> \r\n</head>\r\n\r\n<body>\r\n");

            // end
            // begin [file="/emessenger/setdecision.jsp";from=(10,2);to=(21,0)]
            ...
            // end
            // HTML // begin [file="/emessenger/setdecision.jsp";from=(21,2);to=(25,19)]
                out.write("\r\n\r\n<script language=JavaScript>\r\n<!--\r\ndocument.location=\"");

            // end
            // begin [file="/emessenger/setdecision.jsp";from=(25,22);to=(25,30)]
                out.print(redirect);
            // end
            // HTML // begin [file="/emessenger/setdecision.jsp";from=(25,32);to=(30,7)]
                out.write("\";\r\n//-->\r\n</script>\r\n\r\n</body>\r\n</html>");
