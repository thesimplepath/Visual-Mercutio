...
public class chief$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/emessenger/chief.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<html>\r\n");

            // end
            // HTML // begin [file="/emessenger/chief.jsp";from=(1,32);to=(2,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/emessenger/chief.jsp";from=(2,32);to=(3,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/emessenger/chief.jsp";from=(3,31);to=(4,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/emessenger/chief.jsp";from=(4,26);to=(5,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/emessenger/chief.jsp";from=(5,28);to=(6,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/emessenger/chief.jsp";from=(6,29);to=(7,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/emessenger/chief.jsp";from=(7,25);to=(8,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/emessenger/chief.jsp";from=(8,28);to=(11,0)]
                out.write("\r\n\r\n<head>\r\n");

            // end
            // begin [file="/emessenger/chief.jsp";from=(11,0);to=(11,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/emessenger/chief.jsp";from=(11,53);to=(17,0)]
                out.write("\r\n<link href=\"css/doc.css\" rel=\"styleSheet\" type=\"text/css\"> \r\n<META http-equiv=Content-Type content=\"text/html; charset=utf-8\">\r\n</head>\r\n\r\n<body>\r\n");

            // end
            // begin [file="/emessenger/chief.jsp";from=(17,2);to=(49,0)]
            ...
            // end
            // HTML // begin [file="/emessenger/chief.jsp";from=(49,2);to=(53,19)]
                out.write("\r\n\r\n<script language=JavaScript>\r\n<!--\r\ndocument.location=\"");

            // end
            // begin [file="/emessenger/chief.jsp";from=(53,22);to=(53,30)]
                out.print(redirect);
            // end
            // HTML // begin [file="/emessenger/chief.jsp";from=(53,32);to=(58,7)]
                out.write("\";\r\n//-->\r\n</script>\r\n\r\n</body>\r\n</html>");
