...
public class config$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/emessenger/config.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<html>\r\n");

            // end
            // HTML // begin [file="/emessenger/config.jsp";from=(1,106);to=(5,0)]
                out.write("\r\n<head>\r\n<META http-equiv=Content-Type content=\"text/html; charset=utf-8\">\r\n\r\n");

            // end
            // begin [file="/emessenger/config.jsp";from=(5,0);to=(5,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/emessenger/config.jsp";from=(5,53);to=(6,0)]
                out.write("\r\n");

            // end
            // begin [file="/emessenger/config.jsp";from=(6,2);to=(8,0)]
                
                 String userskin="skin"+(String)session.getAttribute("USERSKIN");
            // end
            // HTML // begin [file="/emessenger/config.jsp";from=(8,2);to=(9,16)]
                out.write("\r\n<link href=\"css/");

            // end
            // begin [file="/emessenger/config.jsp";from=(9,19);to=(9,27)]
                out.print(userskin);
            // end
            // HTML // begin [file="/emessenger/config.jsp";from=(9,29);to=(14,35)]
                out.write("/global.css\" rel=\"styleSheet\" type=\"text/css\">\r\n\r\n<!-- ------------------------------------ //-->\r\n<script language=JavaScript>\r\n//Display tab on top.jsp\r\nvar info1=\"Utilisateur:</td><td><b>");

            // end
            // begin [file="/emessenger/config.jsp";from=(14,38);to=(14,78)]
                out.print((String)session.getAttribute("USERNAME"));
            // end
            // HTML // begin [file="/emessenger/config.jsp";from=(14,80);to=(14,86)]
                out.write("</b>, ");

            // end
            // begin [file="/emessenger/config.jsp";from=(14,89);to=(14,132)]
                out.print((String)session.getAttribute("USERROLETXT"));
            // end
            // HTML // begin [file="/emessenger/config.jsp";from=(14,134);to=(14,136)]
                out.write(" (");

            // end
            // begin [file="/emessenger/config.jsp";from=(14,139);to=(14,187)]
                out.print((String)session.getAttribute("USERWORKGROUPTXT"));
            // end
            // HTML // begin [file="/emessenger/config.jsp";from=(14,189);to=(31,25)]
            ...
            // end
            // begin [file="/emessenger/config.jsp";from=(31,28);to=(31,36)]
                out.print(userskin);
            // end
            // HTML // begin [file="/emessenger/config.jsp";from=(31,38);to=(36,0)]
                out.write("/ard.gif\">&nbsp;</td>\r\n <td><font class=swb>ParamÃ¨tre</font></td>\r\n <td><font class=swf>Valeur</font></td>\r\n </tr>\r\n\r\n");

            // end
            // begin [file="/emessenger/config.jsp";from=(36,2);to=(73,0)]
            ...
            // end
            // HTML // begin [file="/emessenger/config.jsp";from=(73,2);to=(81,7)]
