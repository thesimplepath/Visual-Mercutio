...
public class index$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/emessenger/index.jsp";from=(0,0);to=(2,0)]
                out.write("ï»¿<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\">\r\n<HTML>\r\n");

            // end
            // HTML // begin [file="/emessenger/index.jsp";from=(2,26);to=(3,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/emessenger/index.jsp";from=(3,29);to=(6,0)]
                out.write("\r\n<HEAD><TITLE>Sign In</TITLE>\r\n<META HTTP-EQUIV=\"Content-type\" CONTENT=\"text/html; charset=UTF-8\">\r\n");

            // end
            // begin [file="/emessenger/index.jsp";from=(6,2);to=(26,0)]
            ...
            // end
            // HTML // begin [file="/emessenger/index.jsp";from=(26,2);to=(27,16)]
                out.write("\r\n<LINK href=\"css/");

            // end
            // begin [file="/emessenger/index.jsp";from=(27,19);to=(27,27)]
                out.print(userskin);
            // end
            // HTML // begin [file="/emessenger/index.jsp";from=(27,29);to=(56,24)]
            ...
            // end
            // begin [file="/emessenger/index.jsp";from=(56,27);to=(56,50)]
                out.print(PsConfig.get("COMPANY"));
            // end
            // HTML // begin [file="/emessenger/index.jsp";from=(56,52);to=(88,0)]
