...
public class deliv$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/emessenger/deliv.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<html>\r\n");

            // end
            // HTML // begin [file="/emessenger/deliv.jsp";from=(1,80);to=(4,0)]
                out.write("\r\n<head>\r\n<META http-equiv=Content-Type content=\"text/html; charset=utf-8\">\r\n");

            // end
            // begin [file="/emessenger/deliv.jsp";from=(4,0);to=(4,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/emessenger/deliv.jsp";from=(4,53);to=(9,0)]
                out.write("\r\n<link href=\"css/doc.css\" rel=\"styleSheet\" type=\"text/css\"> \r\n</head>\r\n\r\n<body>\r\n");

            // end
            // begin [file="/emessenger/deliv.jsp";from=(9,2);to=(35,0)]
            ...
            // end
            // HTML // begin [file="/emessenger/deliv.jsp";from=(35,2);to=(40,19)]
                out.write("\r\n\r\n<script language=JavaScript>\r\n<!--\r\n//alert(document.location);\r\ndocument.location=\"");

            // end
            // begin [file="/emessenger/deliv.jsp";from=(40,22);to=(40,30)]
                out.print(redirect);
            // end
            // HTML // begin [file="/emessenger/deliv.jsp";from=(40,32);to=(40,41)]
                out.write("&SESSION=");

            // end
            // begin [file="/emessenger/deliv.jsp";from=(40,44);to=(40,59)]
                out.print(session.getId());
            // end
            // HTML // begin [file="/emessenger/deliv.jsp";from=(40,61);to=(45,7)]
                out.write("\";\r\n//-->\r\n</script>\r\n\r\n</body>\r\n</html>");
