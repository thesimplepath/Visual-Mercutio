...
public class listcase$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/listcase.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<HTML>\r\n");

            // end
            // HTML // begin [file="/listcase.jsp";from=(1,112);to=(3,0)]
                out.write("\r\n<HEAD><TITLE>Search Cases</TITLE>\r\n");

            // end
            // begin [file="/listcase.jsp";from=(3,0);to=(3,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/listcase.jsp";from=(3,53);to=(4,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/listcase.jsp";from=(4,26);to=(5,0)]
                out.write("\r\n");

            // end
            // begin [file="/listcase.jsp";from=(5,2);to=(7,0)]
                
                 String userskin="skin"+(String)session.getAttribute("USERSKIN");
            // end
            // HTML // begin [file="/listcase.jsp";from=(7,2);to=(8,16)]
                out.write("\r\n<link href=\"css/");

            // end
            // begin [file="/listcase.jsp";from=(8,19);to=(8,27)]
                out.print(userskin);
            // end
            // HTML // begin [file="/listcase.jsp";from=(8,29);to=(13,0)]
                out.write("/global.css\" rel=\"styleSheet\" type=\"text/css\">\r\n\r\n<META http-equiv=Content-Type content=\"text/html; charset=utf-8\">\r\n\r\n\r\n");

            // end
            // begin [file="/listcase.jsp";from=(13,2);to=(33,0)]
            ...
            // end
            // HTML // begin [file="/listcase.jsp";from=(33,2);to=(38,35)]
                out.write("\r\n\r\n<!-- ------------------------------------ //-->\r\n<script language=JavaScript>\r\n//Display tab on top.jsp\r\nvar info1=\"Utilisateur:</td><td><b>");

            // end
            // begin [file="/listcase.jsp";from=(38,38);to=(38,78)]
                out.print((String)session.getAttribute("USERNAME"));
            // end
            // HTML // begin [file="/listcase.jsp";from=(38,80);to=(38,86)]
                out.write("</b>, ");

            // end
            // begin [file="/listcase.jsp";from=(38,89);to=(38,132)]
                out.print((String)session.getAttribute("USERROLETXT"));
            // end
            // HTML // begin [file="/listcase.jsp";from=(38,134);to=(38,136)]
                out.write(" (");

            // end
            // begin [file="/listcase.jsp";from=(38,139);to=(38,187)]
                out.print((String)session.getAttribute("USERWORKGROUPTXT"));
            // end
            // HTML // begin [file="/listcase.jsp";from=(38,189);to=(40,12)]
                out.write(")\";\r\nvar info2=\"\";\r\nvar tabno=1+");

            // end
            // begin [file="/listcase.jsp";from=(40,15);to=(40,19)]
                out.print(mode);
            // end
            // HTML // begin [file="/listcase.jsp";from=(40,21);to=(55,0)]
            ...
            // end
            // begin [file="/listcase.jsp";from=(55,2);to=(57,0)]
                
                if (mode==2) {
            // end
            // HTML // begin [file="/listcase.jsp";from=(57,2);to=(61,67)]
                out.write("\r\n\t<TR class=Bg>\r\n\t<TD width=\"3%\">&nbsp;</TD>\r\n\t<TD width=\"17%\">Recherche:</TD>\r\n\t<TD width=\"70%\" colspan=5><input type=text NAME=KEYSEARCH  value=\"");

            // end
            // begin [file="/listcase.jsp";from=(61,70);to=(61,79)]
                out.print(searchKey);
            // end
            // HTML // begin [file="/listcase.jsp";from=(61,81);to=(66,0)]
            ...
            // end
            // begin [file="/listcase.jsp";from=(66,2);to=(68,0)]
                
                 }
            // end
            // HTML // begin [file="/listcase.jsp";from=(68,2);to=(70,69)]
                out.write("\r\n        <TR class=Bg>\r\n          <TD width=\"3%\" height=23 valign=bottom>&nbsp;<img src=\"img/");

            // end
            // begin [file="/listcase.jsp";from=(70,72);to=(70,80)]
                out.print(userskin);
            // end
            // HTML // begin [file="/listcase.jsp";from=(70,82);to=(74,0)]
                out.write("/ard.gif\"></TD>\r\n          <TD width=\"17%\"><NOBR><A title=\"Trier par statut\" \r\n            href=\"\"><FONT \r\n            class=menu>Statut</FONT></A></NOBR><NOBR></NOBR><NOBR>&nbsp;</NOBR></TD>\r\n");

            // end
            // begin [file="/listcase.jsp";from=(74,2);to=(76,0)]
                
                if (mode==2) {
            // end
            // HTML // begin [file="/listcase.jsp";from=(76,2);to=(78,87)]
            ...
            // end
            // begin [file="/listcase.jsp";from=(78,90);to=(78,98)]
                out.print(userskin);
            // end
            // HTML // begin [file="/listcase.jsp";from=(78,100);to=(86,0)]
            ...
            // end
            // begin [file="/listcase.jsp";from=(86,2);to=(88,0)]
                
                 } else {
            // end
            // HTML // begin [file="/listcase.jsp";from=(88,2);to=(90,87)]
                out.write("\r\n          <TD width=\"36%\" class=BgL><NOBR><A title=\"Trier par expÃ©diteur\" \r\n            href=\"\"><IMG height=7 alt=\"triÃ© par ordre dÃ©croissant\" hspace=3 src=\"img/");

            // end
            // begin [file="/listcase.jsp";from=(90,90);to=(90,98)]
                out.print(userskin);
            // end
            // HTML // begin [file="/listcase.jsp";from=(90,100);to=(95,0)]
                out.write("/desc.gif\" width=7 border=0><FONT \r\n            class=swnub>Livrables de la combinaison</FONT></A></NOBR><NOBR></NOBR><NOBR>&nbsp;</NOBR></TD>\r\n          <TD width=\"23%\"><NOBR><A title=\"Trier par procedure\" \r\n            href=\"\"><FONT \r\n            class=menu>ProcÃ©dure</FONT></A></NOBR><NOBR></NOBR><NOBR>&nbsp;</NOBR></TD>\r\n");

            // end
            // begin [file="/listcase.jsp";from=(95,2);to=(97,1)]
                
                 }
                 
            // end
            // HTML // begin [file="/listcase.jsp";from=(97,3);to=(107,0)]
            ...
            // end
            // begin [file="/listcase.jsp";from=(107,2);to=(434,0)]
            ...
            // end
            // HTML // begin [file="/listcase.jsp";from=(434,2);to=(442,0)]
                out.write("\r\n</TABLE>\r\n</TD>\r\n</TR>\r\n</TABLE>\r\n</FORM>\r\n</BODY>\r\n</HTML>\r\n");
