...
public class setsystem$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/setsystem.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<html>\r\n");

            // end
            // HTML // begin [file="/setsystem.jsp";from=(1,49);to=(2,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/setsystem.jsp";from=(2,26);to=(5,0)]
                out.write("\r\n<head>\r\n<META http-equiv=Content-Type content=\"text/html; charset=utf-8\">\r\n");

            // end
            // begin [file="/setsystem.jsp";from=(5,0);to=(5,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/setsystem.jsp";from=(5,53);to=(11,0)]
                out.write("\r\n<link href=\"css/doc.css\" rel=\"styleSheet\" type=\"text/css\"> \r\n<script language=JavaScript src=\"js/pss.js\"></script>\r\n</head>\r\n\r\n<body>\r\n");

            // end
            // begin [file="/setsystem.jsp";from=(11,2);to=(22,0)]
            ...
            // end
            // HTML // begin [file="/setsystem.jsp";from=(22,2);to=(26,21)]
                out.write("\t\r\n\r\n<script language=JavaScript>\r\n<!--\r\n//document.location=\"");

            // end
            // begin [file="/setsystem.jsp";from=(26,24);to=(26,29)]
                out.print(redir);
            // end
            // HTML // begin [file="/setsystem.jsp";from=(26,31);to=(31,7)]
                out.write("\";\r\n//-->\r\n</script>\r\n\r\n</body>\r\n</html>");
