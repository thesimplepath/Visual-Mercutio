...
public class acceuil$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/acceuil.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<html>\r\n");

            // end
            // HTML // begin [file="/acceuil.jsp";from=(1,63);to=(3,0)]
                out.write("\r\n<head>\r\n");

            // end
            // begin [file="/acceuil.jsp";from=(3,0);to=(3,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/acceuil.jsp";from=(3,53);to=(4,0)]
                out.write("\r\n");

            // end
            // begin [file="/acceuil.jsp";from=(4,2);to=(6,0)]
                
                 String userskin="skin"+(String)session.getAttribute("USERSKIN");
            // end
            // HTML // begin [file="/acceuil.jsp";from=(6,2);to=(7,16)]
                out.write("\r\n<link href=\"css/");

            // end
            // begin [file="/acceuil.jsp";from=(7,19);to=(7,27)]
                out.print(userskin);
            // end
            // HTML // begin [file="/acceuil.jsp";from=(7,29);to=(16,36)]
            ...
            // end
            // begin [file="/acceuil.jsp";from=(16,39);to=(16,79)]
                out.print((String)session.getAttribute("USERNAME"));
            // end
            // HTML // begin [file="/acceuil.jsp";from=(16,81);to=(16,87)]
                out.write("</b>, ");

            // end
            // begin [file="/acceuil.jsp";from=(16,90);to=(16,133)]
                out.print((String)session.getAttribute("USERROLETXT"));
            // end
            // HTML // begin [file="/acceuil.jsp";from=(16,135);to=(16,137)]
                out.write(" (");

            // end
            // begin [file="/acceuil.jsp";from=(16,140);to=(16,188)]
                out.print((String)session.getAttribute("USERWORKGROUPTXT"));
            // end
            // HTML // begin [file="/acceuil.jsp";from=(16,190);to=(25,0)]
                out.write(")\";\r\n\tvar info2=\"Welcome...\";\r\n\tvar tabno=0;\r\n\ttop.showTabText(tabno,info1,info2);\r\n}\r\n//document.onload=delayedDisplay();\r\n</script>\r\n<!-- ------------------------------------ //-->\r\n\r\n");

            // end
            // begin [file="/acceuil.jsp";from=(25,2);to=(52,0)]
            ...
            // end
            // HTML // begin [file="/acceuil.jsp";from=(52,2);to=(55,0)]
                out.write("\r\n\r\n<body onload=\"delayedDisplay();\">\r\n");

            // end
            // begin [file="/acceuil.jsp";from=(55,3);to=(55,33)]
                out.print(PsConfig.get("WELCOME_SCREEN"));
            // end
            // HTML // begin [file="/acceuil.jsp";from=(55,35);to=(63,69)]
            ...
            // end
            // begin [file="/acceuil.jsp";from=(63,72);to=(63,80)]
                out.print(userskin);
            // end
            // HTML // begin [file="/acceuil.jsp";from=(63,82);to=(70,20)]
                out.write("/ard.gif\"></TD>\r\n          <TD width=\"87%\"><FONT class=menu>Statistiques</FONT></TD>\r\n          <TD width=\"10%\" class=BgL><FONT class=menu>&nbsp;</FONT></TD>\r\n\t</TR>\r\n\t<TR>\r\n \t  <TD>&nbsp;</TD>\r\n \t  <TD>Nombre de cas:</TD>\r\n \t  <TD align=right>");

            // end
            // begin [file="/acceuil.jsp";from=(70,23);to=(70,33)]
                out.print(nbrCaseAll);
            // end
            // HTML // begin [file="/acceuil.jsp";from=(70,35);to=(75,20)]
                out.write("</TD>\r\n\t</TR>\r\n\t<TR>\r\n \t  <TD>&nbsp;</TD>\r\n \t  <TD>Nombre de cas en attente:</TD>\r\n \t  <TD align=right>");

            // end
            // begin [file="/acceuil.jsp";from=(75,23);to=(75,34)]
                out.print(nbrCaseWait);
            // end
            // HTML // begin [file="/acceuil.jsp";from=(75,36);to=(80,20)]
                out.write("</TD>\r\n\t</TR>\r\n\t<TR>\r\n \t  <TD>&nbsp;</TD>\r\n \t  <TD>Nombre de cas en cours de travail:</TD>\r\n \t  <TD align=right>");

            // end
            // begin [file="/acceuil.jsp";from=(80,23);to=(80,34)]
                out.print(nbrCaseLock);
            // end
            // HTML // begin [file="/acceuil.jsp";from=(80,36);to=(87,7)]
                out.write("</TD>\r\n\t</TR>\t\r\n      </TABLE>\r\n  </TR>\r\n</TABLE>\r\n\r\n</body>\r\n</html>");
