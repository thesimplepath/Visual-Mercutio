...
public class detaildeliv$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/detaildeliv.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<HTML>\r\n");

            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(1,102);to=(4,0)]
                out.write("\r\n\r\n<HEAD><TITLE>Detailed Case</TITLE>\r\n");

            // end
            // begin [file="/detaildeliv.jsp";from=(4,0);to=(4,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(4,53);to=(5,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(5,26);to=(7,0)]
                out.write("\r\n<META http-equiv=Content-Type content=\"text/html; charset=utf-8\">\r\n");

            // end
            // begin [file="/detaildeliv.jsp";from=(7,2);to=(9,0)]
                
                 String userskin="skin"+(String)session.getAttribute("USERSKIN");
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(9,2);to=(10,16)]
                out.write("\r\n<link href=\"css/");

            // end
            // begin [file="/detaildeliv.jsp";from=(10,19);to=(10,27)]
                out.print(userskin);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(10,29);to=(33,13)]
            ...
            // end
            // begin [file="/detaildeliv.jsp";from=(33,16);to=(33,58)]
                out.print((String)request.getParameter( "REDIRECT" ));
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(33,60);to=(109,69)]
            ...
            // end
            // begin [file="/detaildeliv.jsp";from=(109,72);to=(109,80)]
                out.print(userskin);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(109,82);to=(112,0)]
                out.write("/ard.gif\"></TD>\r\n          <TD width=\"96%\"><NOBR><FONT class=menu>Informations</FONT> (<a class=menu name=CNT1></a>)</NOBR><NOBR>&nbsp;</NOBR></TD>\r\n        </TR>\r\n");

            // end
            // begin [file="/detaildeliv.jsp";from=(112,2);to=(174,0)]
            ...
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(174,2);to=(179,56)]
                out.write("\r\n\r\n<script language=JavaScript>\r\n// ----------------------------------------------------------------\r\n//Display tab on top.jsp\r\nvar info1=\"Utilisateur:</td><td colspan=2 nobr><NOBR><b>");

            // end
            // begin [file="/detaildeliv.jsp";from=(179,59);to=(179,99)]
                out.print((String)session.getAttribute("USERNAME"));
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(179,101);to=(179,107)]
                out.write("</b>, ");

            // end
            // begin [file="/detaildeliv.jsp";from=(179,110);to=(179,153)]
                out.print((String)session.getAttribute("USERROLETXT"));
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(179,155);to=(179,157)]
                out.write(" (");

            // end
            // begin [file="/detaildeliv.jsp";from=(179,160);to=(179,208)]
                out.print((String)session.getAttribute("USERWORKGROUPTXT"));
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(179,210);to=(180,27)]
                out.write(")</NOBR>\";\r\nvar info2=\"Cas:</td><td><b>");

            // end
            // begin [file="/detaildeliv.jsp";from=(180,30);to=(180,38)]
                out.print(casename);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(180,40);to=(180,42)]
                out.write(", ");

            // end
            // begin [file="/detaildeliv.jsp";from=(180,45);to=(180,54)]
                out.print(transname);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(180,56);to=(180,118)]
                out.write("</b></td><td align=right><FONT class=menu>Livrable:</font> <b>");

            // end
            // begin [file="/detaildeliv.jsp";from=(180,121);to=(180,130)]
                out.print(delivname);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(180,132);to=(187,13)]
                out.write("</b>\";\r\ntop.showText(info1,info2);\r\n// ----------------------------------------------------------------\r\n</script>\r\n\r\n</tbody></table></td></tr>\r\n<script language=JavaScript>\r\nprocessRow(1,");

            // end
            // begin [file="/detaildeliv.jsp";from=(187,16);to=(187,20)]
                out.print(ncnt);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(187,22);to=(197,69)]
                out.write(");\r\n</script>\r\n\r\n <TR id=ROW2>\r\n    <TD width=\"1%\">&nbsp;</TD>\r\n    <TD class=NormalBlack vAlign=top width=\"99%\">\r\n      <TABLE class=Mtable id=TaskTable cellSpacing=0 cellPadding=0  width=\"100%\">\r\n        <TBODY>\r\n        <TR class=Bg>\r\n          <TD align=middle width=\"1%\" height=23><NOBR>&nbsp;</NOBR></TD>\r\n          <TD width=\"3%\" height=23 valign=bottom>&nbsp;<img src=\"img/");

            // end
            // begin [file="/detaildeliv.jsp";from=(197,72);to=(197,80)]
                out.print(userskin);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(197,82);to=(199,109)]
            ...
            // end
            // begin [file="/detaildeliv.jsp";from=(199,112);to=(199,120)]
                out.print(userskin);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(199,122);to=(202,0)]
                out.write("/desc.gif\" width=7 border=0>\r\n\t\t<FONT class=sbbd>Date</FONT>&nbsp;</NOBR></TD>\r\n        </TR>\r\n");

            // end
            // begin [file="/detaildeliv.jsp";from=(202,2);to=(232,0)]
            ...
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(232,2);to=(235,13)]
                out.write("\r\n</tbody></table></td></tr>\r\n<script language=JavaScript>\r\nprocessRow(2,");

            // end
            // begin [file="/detaildeliv.jsp";from=(235,16);to=(235,20)]
                out.print(ncnt);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(235,22);to=(245,69)]
                out.write(");\r\n</script>\r\n\r\n  <TR id=ROW3>\r\n    <TD width=\"1%\">&nbsp;</TD>\r\n    <TD class=NormalBlack vAlign=top width=\"99%\">\r\n      <TABLE class=Mtable id=TaskTable cellSpacing=0 cellPadding=0  width=\"100%\">\r\n        <TBODY>\r\n        <TR class=Bg>\r\n          <TD align=middle width=\"1%\" height=23><NOBR>&nbsp;</NOBR></TD>\r\n          <TD width=\"3%\" height=23 valign=bottom>&nbsp;<img src=\"img/");

            // end
            // begin [file="/detaildeliv.jsp";from=(245,72);to=(245,80)]
                out.print(userskin);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(245,82);to=(247,109)]
                out.write("/ard.gif\"></TD>\r\n          <TD width=\"82%\"><NOBR><FONT class=menu>RÃ©fÃ©rences</FONT> (<a class=menu name=CNT3></a>)</NOBR><NOBR>&nbsp;</NOBR></TD>\r\n          <TD width=\"14%\" class=BgL><NOBR><IMG height=7 alt=\"triÃ© par ordre dÃ©croissant\" hspace=3 src=\"img/");

            // end
            // begin [file="/detaildeliv.jsp";from=(247,112);to=(247,120)]
                out.print(userskin);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(247,122);to=(250,0)]
                out.write("/desc.gif\" width=7 border=0>\r\n\t\t<FONT class=sbbd>Date</FONT>&nbsp;</NOBR></TD>\r\n        </TR>\r\n");

            // end
            // begin [file="/detaildeliv.jsp";from=(250,2);to=(301,0)]
            ...
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(301,2);to=(304,13)]
                out.write("\r\n</tbody></table></td></tr>\r\n<script language=JavaScript>\r\nprocessRow(3,");

            // end
            // begin [file="/detaildeliv.jsp";from=(304,16);to=(304,20)]
                out.print(ncnt);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(304,22);to=(313,69)]
                out.write(");\r\n</script>\r\n <TR id=ROW4>\r\n    <TD width=\"1%\">&nbsp;</TD>\r\n    <TD class=NormalBlack vAlign=top width=\"99%\">\r\n      <TABLE class=Mtable id=TaskTable cellSpacing=0 cellPadding=0  width=\"100%\">\r\n        <TBODY>\r\n        <TR class=Bg>\r\n          <TD align=middle width=\"1%\" height=23><NOBR>&nbsp;</NOBR></TD>\r\n          <TD width=\"3%\" height=23 valign=bottom>&nbsp;<img src=\"img/");

            // end
            // begin [file="/detaildeliv.jsp";from=(313,72);to=(313,80)]
                out.print(userskin);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(313,82);to=(316,109)]
            ...
            // end
            // begin [file="/detaildeliv.jsp";from=(316,112);to=(316,120)]
                out.print(userskin);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(316,122);to=(319,0)]
                out.write("/desc.gif\" width=7 border=0>\r\n\t\t<FONT class=sbbd>Date</FONT>&nbsp;</NOBR></TD>\r\n        </TR>\r\n");

            // end
            // begin [file="/detaildeliv.jsp";from=(319,2);to=(344,0)]
            ...
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(344,2);to=(347,13)]
                out.write("\r\n</tbody></table></td></tr>\r\n<script language=JavaScript>\r\nprocessRow(4,");

            // end
            // begin [file="/detaildeliv.jsp";from=(347,16);to=(347,20)]
                out.print(ncnt);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(347,22);to=(357,69)]
                out.write(");\r\n</script>\r\n\r\n  <TR id=ROW5>\r\n    <TD width=\"1%\">&nbsp;</TD>\r\n    <TD class=NormalBlack vAlign=top width=\"99%\">\r\n      <TABLE class=Mtable id=TaskTable cellSpacing=0 cellPadding=0  width=\"100%\">\r\n        <TBODY>\r\n        <TR class=Bg>\r\n          <TD align=middle width=\"1%\" height=23><NOBR>&nbsp;</NOBR></TD>\r\n          <TD width=\"3%\" height=23 valign=bottom>&nbsp;<img src=\"img/");

            // end
            // begin [file="/detaildeliv.jsp";from=(357,72);to=(357,80)]
                out.print(userskin);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(357,82);to=(359,109)]
                out.write("/ard.gif\"></TD>\r\n          <TD width=\"82%\"><NOBR><FONT class=menu>Saisie d'attributs</FONT> (<a class=menu name=CNT5></a>)</NOBR><NOBR>&nbsp;</NOBR></TD>\r\n          <TD width=\"14%\" class=BgL><NOBR><IMG height=7 alt=\"triÃ© par ordre dÃ©croissant\" hspace=3 src=\"img/");

            // end
            // begin [file="/detaildeliv.jsp";from=(359,112);to=(359,120)]
                out.print(userskin);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(359,122);to=(362,0)]
                out.write("/desc.gif\" width=7 border=0>\r\n\t\t<FONT class=sbbd>Date</FONT>&nbsp;</NOBR></TD>\r\n        </TR>\r\n");

            // end
            // begin [file="/detaildeliv.jsp";from=(362,2);to=(401,0)]
            ...
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(401,2);to=(404,13)]
                out.write("\r\n</tbody></table></td></tr>\r\n<script language=JavaScript>\r\nprocessRow(5,");

            // end
            // begin [file="/detaildeliv.jsp";from=(404,16);to=(404,20)]
                out.print(ncnt);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(404,22);to=(413,11)]
                out.write(");\r\n</script>\r\n\r\n\r\n\r\n</TBODY></TABLE>\r\n\r\n<script language=JavaScript>\r\n//display text if nothing is visible\r\nvar ntotal=");

            // end
            // begin [file="/detaildeliv.jsp";from=(413,14);to=(413,20)]
                out.print(ntotal);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(413,22);to=(429,89)]
            ...
            // end
            // begin [file="/detaildeliv.jsp";from=(429,92);to=(429,98)]
                out.print(caseid);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(429,100);to=(429,101)]
                out.write(",");

            // end
            // begin [file="/detaildeliv.jsp";from=(429,104);to=(429,111)]
                out.print(transid);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(429,113);to=(431,98)]
                out.write(");'>&nbsp;\r\n<!--\r\n\t<input type=button class=sbttn value=\"Retour pour non conformitÃ©\" onclick='javascript:retSender(");

            // end
            // begin [file="/detaildeliv.jsp";from=(431,101);to=(431,107)]
                out.print(procid);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(431,109);to=(431,110)]
                out.write(",");

            // end
            // begin [file="/detaildeliv.jsp";from=(431,113);to=(431,119)]
                out.print(caseid);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(431,121);to=(431,122)]
                out.write(",");

            // end
            // begin [file="/detaildeliv.jsp";from=(431,125);to=(431,132)]
                out.print(transid);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(431,134);to=(432,85)]
                out.write(");'>&nbsp;\r\n\t<input type=button class=sbttn value=\"Remise au chef\" onclick='javascript:sendChief(");

            // end
            // begin [file="/detaildeliv.jsp";from=(432,88);to=(432,94)]
                out.print(procid);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(432,96);to=(432,97)]
                out.write(",");

            // end
            // begin [file="/detaildeliv.jsp";from=(432,100);to=(432,106)]
                out.print(caseid);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(432,108);to=(432,109)]
                out.write(",");

            // end
            // begin [file="/detaildeliv.jsp";from=(432,112);to=(432,119)]
                out.print(transid);
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(432,121);to=(434,111)]
                out.write(");'>&nbsp;\r\n-->\r\n        <input type=button class=sbttn value=\"Revenir Ã  la procÃ©dure\" onclick='javascript:document.location=\"");

            // end
            // begin [file="/detaildeliv.jsp";from=(434,114);to=(434,156)]
                out.print((String)request.getParameter( "REDIRECT" ));
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(434,158);to=(435,0)]
                out.write("\"'>&nbsp;\r\n");

            // end
            // begin [file="/detaildeliv.jsp";from=(435,2);to=(435,73)]
                if (Integer.valueOf(request.getParameter( "LATERAL" )).intValue()>=0) {
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(435,75);to=(436,103)]
                out.write("\r\n\t<input type=button class=sbttn value=\"Envoyer\" style=\"width:200px;\"  onclick='javascript:doStartDeliv(");

            // end
            // begin [file="/detaildeliv.jsp";from=(436,106);to=(436,146)]
                out.print((String)request.getParameter( "PROCID" ));
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(436,148);to=(436,149)]
                out.write(",");

            // end
            // begin [file="/detaildeliv.jsp";from=(436,152);to=(436,192)]
                out.print((String)request.getParameter( "CASEID" ));
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(436,194);to=(436,195)]
                out.write(",");

            // end
            // begin [file="/detaildeliv.jsp";from=(436,198);to=(436,239)]
                out.print((String)request.getParameter( "TRANSID" ));
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(436,241);to=(436,242)]
                out.write(",");

            // end
            // begin [file="/detaildeliv.jsp";from=(436,245);to=(436,286)]
                out.print((String)request.getParameter( "DELIVID" ));
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(436,288);to=(436,289)]
                out.write(",");

            // end
            // begin [file="/detaildeliv.jsp";from=(436,292);to=(436,333)]
                out.print((String)request.getParameter( "LATERAL" ));
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(436,335);to=(437,0)]
                out.write(");'>\r\n");

            // end
            // begin [file="/detaildeliv.jsp";from=(437,2);to=(437,3)]
                }
            // end
            // HTML // begin [file="/detaildeliv.jsp";from=(437,5);to=(444,0)]
                out.write("\r\n\t</td>\r\n    </tr>\r\n  </tbody>\r\n</table>\r\n</BODY>\r\n</HTML>\r\n");
