...
public class newproc1$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/newproc1.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<html>\r\n");

            // end
            // HTML // begin [file="/newproc1.jsp";from=(1,114);to=(2,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/newproc1.jsp";from=(2,26);to=(5,0)]
                out.write("\r\n<head>\r\n<META http-equiv=Content-Type content=\"text/html; charset=utf-8\">\r\n");

            // end
            // begin [file="/newproc1.jsp";from=(5,0);to=(5,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/newproc1.jsp";from=(5,53);to=(6,0)]
                out.write("\r\n");

            // end
            // begin [file="/newproc1.jsp";from=(6,2);to=(8,0)]
                
                 String userskin="skin"+(String)session.getAttribute("USERSKIN");
            // end
            // HTML // begin [file="/newproc1.jsp";from=(8,2);to=(9,16)]
                out.write("\r\n<link href=\"css/");

            // end
            // begin [file="/newproc1.jsp";from=(9,19);to=(9,27)]
                out.print(userskin);
            // end
            // HTML // begin [file="/newproc1.jsp";from=(9,29);to=(99,2)]
            ...
            // end
            // begin [file="/newproc1.jsp";from=(99,4);to=(113,0)]
                ...
                try {
                	...
                	{
            // end
            // HTML // begin [file="/newproc1.jsp";from=(113,2);to=(115,83)]
                out.write("\r\n\t<TR>\r\n        <TD width=\"6%\" align=left><INPUT class=sbttn  onclick='doSetCb(document.F2,");

            // end
            // begin [file="/newproc1.jsp";from=(115,86);to=(115,105)]
                out.print(rs.getInt("caseid"));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(115,107);to=(115,108)]
                out.write(",");

            // end
            // begin [file="/newproc1.jsp";from=(115,111);to=(115,131)]
                out.print(rs.getInt("transid"));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(115,133);to=(115,135)]
                out.write(",\"");

            // end
            // begin [file="/newproc1.jsp";from=(115,138);to=(115,175)]
                out.print(PsConv.c4JS(rs.getString("casename")));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(115,177);to=(115,180)]
                out.write("\",\"");

            // end
            // begin [file="/newproc1.jsp";from=(115,183);to=(115,221)]
                out.print(PsConv.c4JS(rs.getString("transname")));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(115,223);to=(115,246)]
                out.write("\");' type=radio name=CB");

            // end
            // begin [file="/newproc1.jsp";from=(115,249);to=(115,258)]
                out.print((cbcnt++));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(115,260);to=(117,24)]
                out.write(" >\r\n        </TD>\r\n        <TD width=\"32%\">");

            // end
            // begin [file="/newproc1.jsp";from=(117,27);to=(117,51)]
                out.print(rs.getString("casename"));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(117,53);to=(117,55)]
                out.write(", ");

            // end
            // begin [file="/newproc1.jsp";from=(117,58);to=(117,83)]
                out.print(rs.getString("transname"));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(117,85);to=(118,0)]
                out.write("</TD>\r\n");

            // end
            // begin [file="/newproc1.jsp";from=(118,2);to=(121,0)]
                		
                        if (rs.getInt("cnt")==1) 
                		{
            // end
            // HTML // begin [file="/newproc1.jsp";from=(121,2);to=(122,21)]
                out.write("\t\t\r\n\t    <TD width=\"59%\">");

            // end
            // begin [file="/newproc1.jsp";from=(122,24);to=(122,46)]
                out.print(rs.getString("mvalue"));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(122,48);to=(123,0)]
                out.write("</TD></TR>\r\n");

            // end
            // begin [file="/newproc1.jsp";from=(123,2);to=(126,0)]
                		}			
                	else
                		{
            // end
            // HTML // begin [file="/newproc1.jsp";from=(126,2);to=(128,0)]
                out.write("\t\r\n\t    <TD width=\\\"59%\\\">...</TD></TR>\r\n");

            // end
            // begin [file="/newproc1.jsp";from=(128,2);to=(137,0)]
            ...
            // end
            // HTML // begin [file="/newproc1.jsp";from=(137,2);to=(176,2)]
            ...
            // end
            // begin [file="/newproc1.jsp";from=(176,4);to=(187,0)]
                ...
                try {
                	...
                	{
            // end
            // HTML // begin [file="/newproc1.jsp";from=(187,2);to=(189,83)]
                out.write("\r\n\t<TR>\r\n        <TD width=\"6%\" align=left><INPUT class=sbttn  onclick='doSetCb(document.F3,");

            // end
            // begin [file="/newproc1.jsp";from=(189,86);to=(189,105)]
                out.print(rs.getInt("caseid"));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(189,107);to=(189,108)]
                out.write(",");

            // end
            // begin [file="/newproc1.jsp";from=(189,111);to=(189,131)]
                out.print(rs.getInt("transid"));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(189,133);to=(189,135)]
                out.write(",\"");

            // end
            // begin [file="/newproc1.jsp";from=(189,138);to=(189,175)]
                out.print(PsConv.c4JS(rs.getString("casename")));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(189,177);to=(189,180)]
                out.write("\",\"");

            // end
            // begin [file="/newproc1.jsp";from=(189,183);to=(189,221)]
                out.print(PsConv.c4JS(rs.getString("transname")));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(189,223);to=(189,246)]
                out.write("\");' type=radio name=CB");

            // end
            // begin [file="/newproc1.jsp";from=(189,249);to=(189,258)]
                out.print((cbcnt++));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(189,260);to=(191,24)]
                out.write(" >\r\n        </TD>\r\n        <TD width=\"32%\">");

            // end
            // begin [file="/newproc1.jsp";from=(191,27);to=(191,51)]
                out.print(rs.getString("casename"));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(191,53);to=(191,55)]
                out.write(", ");

            // end
            // begin [file="/newproc1.jsp";from=(191,58);to=(191,83)]
                out.print(rs.getString("transname"));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(191,85);to=(192,0)]
                out.write("</TD>\r\n");

            // end
            // begin [file="/newproc1.jsp";from=(192,2);to=(195,0)]
                		
                        if (rs.getInt("cnt")==1) 
                		{
            // end
            // HTML // begin [file="/newproc1.jsp";from=(195,2);to=(196,21)]
                out.write("\t\t\r\n\t    <TD width=\"59%\">");

            // end
            // begin [file="/newproc1.jsp";from=(196,24);to=(196,46)]
                out.print(rs.getString("mvalue"));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(196,48);to=(197,0)]
                out.write("</TD></TR>\r\n");

            // end
            // begin [file="/newproc1.jsp";from=(197,2);to=(200,0)]
                		}			
                	else
                		{
            // end
            // HTML // begin [file="/newproc1.jsp";from=(200,2);to=(202,0)]
                out.write("\t\r\n\t    <TD width=\\\"59%\\\">...</TD></TR>\r\n");

            // end
            // begin [file="/newproc1.jsp";from=(202,2);to=(211,0)]
            ...
            // end
            // HTML // begin [file="/newproc1.jsp";from=(211,2);to=(241,10)]
            ...
            // end
            // begin [file="/newproc1.jsp";from=(241,13);to=(241,54)]
                out.print(PsDbMgr.newConnection().nextVal("PTRANS"));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(241,56);to=(244,43)]
                out.write(";\r\n\telse\r\n\t\ttransid=transattachid;\r\n\tvar dta=new PssData(caseattachid,casename,");

            // end
            // begin [file="/newproc1.jsp";from=(244,46);to=(244,86)]
                out.print((String)request.getParameter( "PROCID" ));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(244,88);to=(244,89)]
                out.write(",");

            // end
            // begin [file="/newproc1.jsp";from=(244,92);to=(244,130)]
                out.print((String)session.getAttribute("USERID"));
            // end
            // HTML // begin [file="/newproc1.jsp";from=(244,132);to=(260,7)]
