...
public class upload$jsp extends HttpJspBase {
    ...
    // begin [file="/upload.jsp";from=(12,0);to=(12,59)]
    // end
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/upload.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<HTML>\r\n");

            // end
            // HTML // begin [file="/upload.jsp";from=(1,174);to=(3,0)]
                out.write("\r\n<HEAD><TITLE>ProcessSoft Mercutio Messenger - Upload</TITLE>\r\n");

            // end
            // begin [file="/upload.jsp";from=(3,0);to=(3,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/upload.jsp";from=(3,53);to=(4,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/upload.jsp";from=(4,26);to=(5,0)]
                out.write("\r\n");

            // end
            // begin [file="/upload.jsp";from=(5,2);to=(7,0)]
                
                 String userskin="skin"+(String)session.getAttribute("USERSKIN");
            // end
            // HTML // begin [file="/upload.jsp";from=(7,2);to=(8,16)]
                out.write("\r\n<link href=\"css/");

            // end
            // begin [file="/upload.jsp";from=(8,19);to=(8,27)]
                out.print(userskin);
            // end
            // HTML // begin [file="/upload.jsp";from=(8,29);to=(12,0)]
            ...
            // end
            // HTML // begin [file="/upload.jsp";from=(12,59);to=(15,0)]
                out.write("\r\n</jsp:useBean>\r\n\r\n");

            // end
            // begin [file="/upload.jsp";from=(15,2);to=(67,1)]
            ...
            // end
            // HTML // begin [file="/upload.jsp";from=(67,3);to=(71,1)]
                out.write("\r\n\t<script language=\"JavaScript\">\r\n\twindow.close();\r\n\t</script>\r\n\t");

            // end
            // begin [file="/upload.jsp";from=(71,3);to=(73,0)]
                
                 }
            // end
            // HTML // begin [file="/upload.jsp";from=(73,2);to=(89,69)]
            ...
            // end
            // begin [file="/upload.jsp";from=(89,72);to=(89,80)]
                out.print(userskin);
            // end
            // HTML // begin [file="/upload.jsp";from=(89,82);to=(96,0)]
                out.write("/ard.gif\"></TD>\r\n          <TD width=\"96%\"><NOBR><FONT class=menu>TÃ©lÃ©chargement</FONT></NOBR></TD>\r\n        </TR>\r\n</TBODY>\r\n</TABLE>\r\n<br>\r\n\r\n");

            // end
            // begin [file="/upload.jsp";from=(96,2);to=(99,0)]
                
                if (mode!=2)
                	{
            // end
            // HTML // begin [file="/upload.jsp";from=(99,2);to=(101,0)]
                out.write("\r\nTÃ©lÃ©chargement de fichiers vers le cas:<br>\r\n");

            // end
            // begin [file="/upload.jsp";from=(101,2);to=(105,0)]
                	...
                	rs.next();
            // end
            // HTML // begin [file="/upload.jsp";from=(105,2);to=(106,3)]
                out.write("\r\n<b>");

            // end
            // begin [file="/upload.jsp";from=(106,6);to=(106,30)]
                out.print(rs.getString("casename"));
            // end
            // HTML // begin [file="/upload.jsp";from=(106,32);to=(106,36)]
                out.write("<br>");

            // end
            // begin [file="/upload.jsp";from=(106,39);to=(106,64)]
                out.print(rs.getString("transname"));
            // end
            // HTML // begin [file="/upload.jsp";from=(106,66);to=(111,39)]
                out.write("</b>\r\n<br> \r\n<FORM action=\"upload.jsp\" method=\"POST\" ENCTYPE=\"multipart/form-data\">\r\n<INPUT TYPE=\"FILE\" style=\"width:100%\" NAME=FILE1>\r\n<INPUT TYPE=\"HIDDEN\" NAME=MODE VALUE=\"2\">\r\n<INPUT TYPE=\"HIDDEN\" NAME=CASEID VALUE=");

            // end
            // begin [file="/upload.jsp";from=(111,42);to=(111,48)]
                out.print(caseid);
            // end
            // HTML // begin [file="/upload.jsp";from=(111,50);to=(112,40)]
                out.write(" >\r\n<INPUT TYPE=\"HIDDEN\" NAME=TRANSID VALUE=");

            // end
            // begin [file="/upload.jsp";from=(112,43);to=(112,50)]
                out.print(transid);
            // end
            // HTML // begin [file="/upload.jsp";from=(112,52);to=(118,0)]
                out.write(" >\r\n<br><br>\r\n<p align=center>\r\n<INPUT TYPE=SUBMIT VALUE=\"Envoi du fichier\">\r\n</p>\r\n</FORM>\r\n");

            // end
            // begin [file="/upload.jsp";from=(118,2);to=(120,0)]
                
                	}
            // end
            // HTML // begin [file="/upload.jsp";from=(120,2);to=(124,0)]
                out.write("\r\n</TABLE>\r\n</BODY>\r\n</HTML>\r\n");
