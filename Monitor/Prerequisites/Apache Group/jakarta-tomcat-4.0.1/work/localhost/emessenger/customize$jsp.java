...
public class customize$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/customize.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<html>\r\n");

            // end
            // HTML // begin [file="/customize.jsp";from=(1,106);to=(4,0)]
                out.write("\r\n<head>\r\n<META http-equiv=Content-Type content=\"text/html; charset=utf-8\">\r\n");

            // end
            // begin [file="/customize.jsp";from=(4,2);to=(6,0)]
                
                 String userskin="skin"+(String)session.getAttribute("USERSKIN");
            // end
            // HTML // begin [file="/customize.jsp";from=(6,2);to=(7,16)]
                out.write("\r\n<link href=\"css/");

            // end
            // begin [file="/customize.jsp";from=(7,19);to=(7,27)]
                out.print(userskin);
            // end
            // HTML // begin [file="/customize.jsp";from=(7,29);to=(9,0)]
                out.write("/global.css\" rel=\"styleSheet\" type=\"text/css\">\r\n\r\n");

            // end
            // begin [file="/customize.jsp";from=(9,0);to=(9,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/customize.jsp";from=(9,53);to=(14,35)]
                out.write("\r\n\r\n<!-- ------------------------------------ //-->\r\n<script language=JavaScript>\r\n//Display tab on top.jsp\r\nvar info1=\"Utilisateur:</td><td><b>");

            // end
            // begin [file="/customize.jsp";from=(14,38);to=(14,78)]
                out.print((String)session.getAttribute("USERNAME"));
            // end
            // HTML // begin [file="/customize.jsp";from=(14,80);to=(14,86)]
                out.write("</b>, ");

            // end
            // begin [file="/customize.jsp";from=(14,89);to=(14,132)]
                out.print((String)session.getAttribute("USERROLETXT"));
            // end
            // HTML // begin [file="/customize.jsp";from=(14,134);to=(14,136)]
                out.write(" (");

            // end
            // begin [file="/customize.jsp";from=(14,139);to=(14,187)]
                out.print((String)session.getAttribute("USERWORKGROUPTXT"));
            // end
            // HTML // begin [file="/customize.jsp";from=(14,189);to=(31,34)]
            ...
            // end
            // begin [file="/customize.jsp";from=(31,37);to=(31,45)]
                out.print(userskin);
            // end
            // HTML // begin [file="/customize.jsp";from=(31,47);to=(36,0)]
                out.write("/ard.gif\">&nbsp;</td>\r\n <td><font class=swb>ParamÃ¨tre</font></td>\r\n <td><font class=swf>Valeur</font></td>\r\n </tr>\r\n\r\n");

            // end
            // begin [file="/customize.jsp";from=(36,2);to=(53,1)]
            ...
            // end
            // HTML // begin [file="/customize.jsp";from=(53,3);to=(55,1)]
                out.write("\r\n\r\n\t");

            // end
            // begin [file="/customize.jsp";from=(55,3);to=(59,8)]
            ...
            // end
            // HTML // begin [file="/customize.jsp";from=(59,10);to=(64,1)]
                out.write("\r\n\r\n\t<script language=JavaScript>\r\n\ttop.document.location=\"logout.jsp\";\r\n\t</script>\r\n\t");

            // end
            // begin [file="/customize.jsp";from=(64,3);to=(66,0)]
                
                  }
            // end
            // HTML // begin [file="/customize.jsp";from=(66,2);to=(96,7)]
