...
public class newproc$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/newproc.jsp";from=(0,0);to=(1,0)]
                out.write("ï»¿<html>\r\n");

            // end
            // HTML // begin [file="/newproc.jsp";from=(1,114);to=(2,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/newproc.jsp";from=(2,26);to=(5,0)]
                out.write("\r\n<head>\r\n<META http-equiv=Content-Type content=\"text/html; charset=utf-8\">\r\n");

            // end
            // begin [file="/newproc.jsp";from=(5,0);to=(5,53)]
                {
                    String _jspx_qStr = "";
                    JspRuntimeLibrary.include(request, response, "checksession.jsp" + _jspx_qStr, out, false);
                }
            // end
            // HTML // begin [file="/newproc.jsp";from=(5,53);to=(6,0)]
                out.write("\r\n");

            // end
            // begin [file="/newproc.jsp";from=(6,2);to=(8,0)]
                
                 String userskin="skin"+(String)session.getAttribute("USERSKIN");
            // end
            // HTML // begin [file="/newproc.jsp";from=(8,2);to=(9,16)]
                out.write("\r\n<link href=\"css/");

            // end
            // begin [file="/newproc.jsp";from=(9,19);to=(9,27)]
                out.print(userskin);
            // end
            // HTML // begin [file="/newproc.jsp";from=(9,29);to=(12,40)]
            ...
            // end
            // begin [file="/newproc.jsp";from=(12,43);to=(12,83)]
                out.print((String)session.getAttribute("USERNAME"));
            // end
            // HTML // begin [file="/newproc.jsp";from=(12,85);to=(39,63)]
            ...
            // end
            // begin [file="/newproc.jsp";from=(39,66);to=(39,74)]
                out.print(userskin);
            // end
            // HTML // begin [file="/newproc.jsp";from=(39,76);to=(63,0)]
            ...
            // end
            // begin [file="/newproc.jsp";from=(63,2);to=(78,0)]
                ...
                try {
                	...
                	while (rs.next())
                	{
                		...
                		{
            // end
            // HTML // begin [file="/newproc.jsp";from=(78,2);to=(81,55)]
                out.write("\r\n\r\n<tr>\r\n<td valign=bottom width=\"2%\"><a href=\"bpml.jsp?MODELID=");

            // end
            // begin [file="/newproc.jsp";from=(81,58);to=(81,81)]
                out.print(rs.getString("modelid"));
            // end
            // HTML // begin [file="/newproc.jsp";from=(81,83);to=(83,0)]
                out.write("\"><img src=\"img/arr.gif\" border=\"0\"></a></td>\r\n<td valign=bottom>\r\n");

            // end
            // begin [file="/newproc.jsp";from=(83,3);to=(83,26)]
                out.print(rs2.getInt("versionno"));
            // end
            // HTML // begin [file="/newproc.jsp";from=(83,28);to=(86,0)]
                out.write("\r\n</td>\r\n<td valign=bottom>\r\n");

            // end
            // begin [file="/newproc.jsp";from=(86,3);to=(86,27)]
                out.print(rs2.getString("pubdate"));
            // end
            // HTML // begin [file="/newproc.jsp";from=(86,29);to=(89,27)]
                out.write("\r\n</td>\r\n<td valign=bottom>\r\n<a title=\"Model Reference: ");

            // end
            // begin [file="/newproc.jsp";from=(89,30);to=(89,54)]
                out.print(rs.getString("modelref"));
            // end
            // HTML // begin [file="/newproc.jsp";from=(89,56);to=(89,73)]
                out.write("\" href=\"public/1/");

            // end
            // begin [file="/newproc.jsp";from=(89,76);to=(89,121)]
                out.print(PsConv.c4FS(rs.getString("modelname").trim()));
            // end
            // HTML // begin [file="/newproc.jsp";from=(89,123);to=(90,0)]
                out.write(".htm\">\r\n");

            // end
            // begin [file="/newproc.jsp";from=(90,3);to=(90,28)]
                out.print(rs.getString("modelname"));
            // end
            // HTML // begin [file="/newproc.jsp";from=(90,30);to=(95,0)]
                out.write("\r\n</a>\r\n</td>\r\n</tr>\r\n\r\n");

            // end
            // begin [file="/newproc.jsp";from=(95,2);to=(104,0)]
            ...
            // end
            // HTML // begin [file="/newproc.jsp";from=(104,2);to=(110,7)]
                out.write("\r\n</td>\r\n</tr>\r\n</table></center>\r\n\r\n</body>\r\n</html>");
